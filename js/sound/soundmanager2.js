...
(function (window) {
    ...
    function SoundManager(smURL, smID) {
        ...
        var SMSound,
            ...
            _isBadSafari =
                !_wl.match(/usehtml5audio/i) &&
                !_wl.match(/sm2\-ignorebadua/i) &&
                _isSafari &&
                _ua.match(/OS X 10_6_([3-7])/i), // Safari 4 and 5 occasionally fail to load/play HTML5 audio on Snow Leopard 10.6.3 through 10.6.7 due to bug(s) in QuickTime X and/or other underlying frameworks. :/ Confirmed bug. https://bugs.webkit.org/show_bug.cgi?id=32159
            ...
            if (_html5OK(_tO)) {
                ...
                if (_fV > 8) {
                    if (_tO.isMovieStar === null) {
                        ...
                        _tO.isMovieStar =
                            _tO.serverURL ||
                            (_tO.type ? _tO.type.match(_netStreamMimeTypes) : false) ||
                            _tO.url.match(_netStreamPattern);
                    }
                    // <d>
                    if (_tO.isMovieStar) {
                ...
                if (_fV === 8) {
                    ...
                    _s.o._createSound(
                        ...
                        _tO.useEQData,
                        _tO.isMovieStar,
                        _tO.isMovieStar ? _tO.bufferTime : false,
                        _tO.loops || 1,
                        _tO.serverURL,
                        _tO.duration || null,
                        _tO.autoPlay,
        ...
        this.canPlayMIME = function (sMIME) {
            ...
            if (!_needsFlash || result) {
                ...
                return sMIME
                    ? !!((_fV > 8 ? sMIME.match(_netStreamMimeTypes) : null) || sMIME.match(_s.mimePattern))
                    : null;
            }
        };
        ...
        SMSound = function (oOptions) {
                    ...
                    try {
                        ...
                        if (_fV === 8) {
                            _s.o._load(
                                ...
                                _t._iO.stream,
                                _t._iO.autoPlay,
                                _t._iO.whileloading ? 1 : 0,
                                _t._iO.loops || 1,
                                _t._iO.usePolicyFile
                            );
                        } else {
                            _s.o._load(
                                _t.sID,
            ...
            this.play = function (oOptions, _updatePlayState) {
                ...
                if (_t.paused && _t.position && _t.position > 0) {
                    ...
                    _t.position =
                        typeof _t._iO.position !== "undefined" && !isNaN(_t._iO.position) ? _t._iO.position : 0;
                    ...
                    if (!_t.isHTML5) {
                        _s.o._start(
                            _t.sID,
                            _t._iO.loops || 1,
                            _fV === 9 ? _t._iO.position : _t._iO.position / 1000,
                            _t._iO.numSamples
                        );
                    } else {
                        _start_html5_timer();
            ...
            this.setPosition = function (nMsecOffset) {
                ...
                var original_pos,
                    ...
                    offset = _t.isHTML5
                        ...
                        : Math.min(_t.duration || _t._iO.duration, Math.max(nMsecOffset, 0));
                    ...
                    if (_t._a && (bForce || ((_t.playState > 0 || _t.readyState === 1) && !_t.paused))) {
                        ...
                        _s._wD(
                            '_onTimer: Warn for "' +
                                _t.sID +
                                '": ' +
                                (!_t._a ? "Could not find element. " : "") +
                                (_t.playState === 0 ? "playState bad, 0?" : "playState = " + _t.playState + ", OK")
                        );
                        return false;
                    }
                }
            ...
            this._setup_html5 = function (oOptions) {
                ...
                if (_a) {
                    ...
                    _s._wD(
                        "setting new URL on existing object: " +
                            _dURL +
                            (_t._lastURL ? ", old URL: " + _t._lastURL : "")
                    );
            ...
            this._onload = function (nSuccess) {
                var fN = "SMSound._onload(): ",
                    loadOK = !!nSuccess;
                _s._wD(
                    fN + '"' + _t.sID + '"' + (loadOK ? " loaded." : " failed to load? - " + _t.url),
                    loadOK ? 1 : 2
                );
                // <d>
            ...
            this._onconnect = function (bSuccess) {
                ...
                bSuccess = bSuccess === 1;
                _s._wD(
                    fN + '"' + _t.sID + '"' + (bSuccess ? " connected." : " failed to connect? - " + _t.url),
                    bSuccess ? 1 : 2
                );
        ...
        _html5OK = function (iO) {
            ...
            return (
                !iO.serverURL &&
                (iO.type ? _html5CanPlay({ type: iO.type }) : _html5CanPlay({ url: iO.url }) || _s.html5Only)
            );
        };
        ...
        _html5CanPlay = function (o) {
            ...
            function preferFlashCheck(kind) {
                ...
                return (
                    ...
                    _hasFlash &&
                    !_s.ignoreFlash &&
                    typeof _s.flash[kind] !== "undefined" &&
                    _s.flash[kind]
                );
            }
        ...
        _policyFix = function (sOpt, sPre) {
            if (
                sOpt &&
                !sOpt.usePolicyFile &&
                (sOpt.onid3 || sOpt.usePeakData || sOpt.useWaveformData || sOpt.useEQData)
            ) {
        ...
        _normalizeMovieURL = function (smURL) {
            ...
            return (
                (smURL && smURL.lastIndexOf("/") !== -1 ? smURL.substr(0, smURL.lastIndexOf("/") + 1) : "./") +
                _s.movieURL
            );
        };
        ...
        _setVersionInfo = function () {
            ...
            _s.version =
                _s.versionNumber +
                (_s.html5Only ? " (HTML5-only mode)" : _fV === 9 ? " (AS3/Flash 9)" : " (AS2/Flash 8)");
            ...
            _s.movieURL = (_fV === 8 ? "swf/soundmanager2.swf" : "swf/soundmanager2_flash9.swf").replace(
                ".swf",
                isDebug
            );
        ...
        _initDebug = function () {
            ...
            if (
                _s.debugMode &&
                !_id(_s.debugID) &&
                (!_hasConsole || !_s.useConsole || (_s.useConsole && _hasConsole && !_s.consoleOnly))
            ) {
        ...
        _flashBlockHandler = function () {
            ...
            if (!_s.ok()) {
                if (_needsFlash) {
                    ...
                    _s.oMC.className =
                        _getSWFCSS() + " " + css.swfDefault + " " + (p === null ? css.swfTimedout : css.swfError);
                ...
                if (_s.oMC) {
                    _s.oMC.className = [
                        _getSWFCSS(),
                        css.swfDefault,
                        css.swfLoaded + (_s.didFlashBlock ? " " + css.swfUnblocked : ""),
                    ].join(" ");
                }
            }
        };
        ...
        _processOnEvents = function (oOptions) {
            ...
            if (queue.length) {
                _s._wD(
                    _sm + ": Firing " + queue.length + " " + oOptions.type + "() item" + (queue.length === 1 ? "" : "s")
                );
        ...
        _featureCheck = function () {
            ...
            for (item in _s.audioFormats) {
                if (_s.audioFormats.hasOwnProperty(item)) {
                    if (
                        (_s.audioFormats[item].required && !_s.html5.canPlayType(_s.audioFormats[item].type)) ||
                        _s.flash[item] ||
                        _s.flash[_s.audioFormats[item].type]
                    ) {
        ...
        _createMovie = function (smID, smURL) {
                    ...
                    "-- SoundManager 2 " +
                        ...
                        (!_s.html5Only
                            ? (_s.useHighPerformance ? ", high performance mode, " : ", ") +
                              ((_s.flashPollingInterval ? "custom (" + _s.flashPollingInterval + "ms)" : "normal") +
                                  " polling") +
                              (_s.wmode ? ", wmode: " + _s.wmode : "") +
                              (_s.debugFlash ? ", flash debug mode" : "") +
                              (_s.useFlashBlock ? ", flashBlock mode" : "")
                            : "") +
                        " --",
                    1
                );
            ...
            if (
                _s.wmode !== null &&
                (_ua.match(/msie 8/i) || (!_isIE && !_s.useHighPerformance)) &&
            ...
            if (_isIE) {
                ...
                movieHTML = [
                    '<object id="' +
                        ...
                        _http +
                        'download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,40,0" width="' +
                        oEmbed.width +
                        '" height="' +
                        oEmbed.height +
                        '">',
            ...
            if (oTarget) {
                ...
                if (!_s.oMC.id) {
                    ...
                    _s.oMC.className =
                        (sClass ? sClass + " " : _s.swfCSS.swfDefault) + (extraClass ? " " + extraClass : "");
                    _s.oMC.appendChild(oMovie);
                    if (_isIE) {
                        oEl = _s.oMC.appendChild(_doc.createElement("div"));
                        oEl.className = _s.swfCSS.swfBox;
            ...
            _initMsg();
            _s._wD(
                _smc + "createMovie(): Trying to load " + smURL + (!_overHTTP && _s.altURL ? " (alternate URL)" : ""),
                1
            );
        ...
        _waitForEI = function () {
            ...
            setTimeout(function () {
                ...
                if (!_didInit) {
                    _s._wD(
                        _sm +
                            ": No Flash response within expected time.\nLikely causes: " +
                            (p === 0
                                ? "Loading " +
                                  _s.movieURL +
                                  " may have failed (and/or Flash " +
                                  _fV +
                                  "+ not present?), "
                                : "") +
                            "Flash blocked or JS-Flash security error." +
                            (_s.debugFlash ? " " + _str("checkSWF") : ""),
                        2
                    );
                    if (!_overHTTP && p) {
                        _wDS("localFail", 2);
                    ...
                    if (_s.audioFormats.hasOwnProperty(item)) {
                        tests.push(
                            item +
                                ": " +
                                _s.html5[item] +
                                (!_s.html5[item] && _hasFlash && _s.flash[item]
                                    ? " (using flash)"
                                    : _s.preferFlash && _s.flash[item] && _hasFlash
                                    ? " (preferring flash)"
                                    : !_s.html5[item]
                                    ? " (" +
                                      (_s.audioFormats[item].required ? "required, " : "") +
        ...
        _initComplete = function (bNoDisable) {
            ...
            _s._wD(
                "-- SoundManager 2 " +
                    (_disabled ? "failed to load" : "loaded") +
                    " (" +
                    (_disabled ? "security/load error" : "OK") +
                    ") --",
                1
            );
            ...
            if (_disabled || bNoDisable) {
                if (_s.useFlashBlock && _s.oMC) {
                    _s.oMC.className =
                        _getSWFCSS() +
                        " " +
                        (_s.getMoviePercent() === null ? _s.swfCSS.swfTimedout : _s.swfCSS.swfError);
                }
        ...
        _domContentLoaded = function () {
            ...
            if (!_hasFlash && _s.hasHTML5) {
                _s._wD(
                    "SoundManager: No Flash detected" +
                        (!_s.useHTML5Audio ? ", enabling HTML5." : ". Trying HTML5-only mode.")
                );
                _s.useHTML5Audio = true;

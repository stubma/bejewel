...
GameFramework.resources.PopAnimResource.prototype = {
            ...
            if (anObjectPos != null && anObjectPos.mData.mIsSprite) {
                ...
                if (aSpriteInst != null) {
                    for (var aPreload = 0; aPreload < anObjectPos.mData.mPreloadFrames; aPreload++) {
                        this.IncSpriteInstFrame(
                            aSpriteInst,
                            anObjectPos,
                            1000.0 / GameFramework.BaseApp.mApp.mFrameTime / theSpriteInst.mDef.mAnimRate
                        );
                    }
                }
            }
                        ...
                        if (this.mPIEffectIdSearchVector != null) {
                            {
                                ...
                                for (var $enum1 = 0; $enum1 < $srcArray1.length; $enum1++) {
                                    ...
                                    aParticleEffect.mEffect =
                                        GameFramework.BaseApp.mApp.mResourceManager.GetPIEffectById(
                                            anIdSearch + aParticleEffect.mName.toUpperCase()
                                        );
    ...
    DrawParticleEffects: function GameFramework_resources_PopAnimResource$DrawParticleEffects(
        g,
        theSpriteInst,
        theTransform,
        theColor,
                ...
                if (aParticleEffect.mTransform) {
                    if (!aParticleEffect.mAttachEmitter) {
                        ...
                        aTransform.translate(
                            aParticleEffect.mEffect.mWidth / 2.0,
                            aParticleEffect.mEffect.mHeight / 2.0
                        );
    ...
    GetToFirstFrame: function GameFramework_resources_PopAnimResource$GetToFirstFrame() {
        while (
            ...
            this.mMainSpriteInst.mFrameNum < this.mMainSpriteInst.mDef.mWorkAreaStart
        ) {
    ...
    LoadSpriteDef: function GameFramework_resources_PopAnimResource$LoadSpriteDef(theBuffer, theSpriteDef) {
        ...
        theSpriteDef.mWorkAreaDuration =
            (Math.min(theSpriteDef.mWorkAreaStart + theSpriteDef.mWorkAreaDuration, aNumFrames - 1) -
                theSpriteDef.mWorkAreaStart) |
            0;
            ...
            if ((aFrameFlags & GameFramework.resources.PopAnimResource.FRAMEFLAGS_HAS_ADDS) != 0) {
                ...
                for (var anAddNum = 0; anAddNum < aNumAdds; anAddNum++) {
                    ...
                    if ((anObjectNumAndType & 0x1000) != 0) {
                        ...
                        aPopAnimObjectPos.mData.mName =
                            this.mMainAnimDef.mObjectNamePool[this.mMainAnimDef.mObjectNamePool.length - 1];
                    }
                    ...
                    if (theSpriteDef.mObjectDefVector[aPopAnimObjectPos.mData.mObjectNum] == null) {
                        theSpriteDef.mObjectDefVector[aPopAnimObjectPos.mData.mObjectNum] =
                            new GameFramework.resources.popanim.PopAnimObjectDef();
                    }
                    theSpriteDef.mObjectDefVector[aPopAnimObjectPos.mData.mObjectNum].mName =
                        aPopAnimObjectPos.mData.mName;
                    if (aPopAnimObjectPos.mData.mIsSprite) {
                        theSpriteDef.mObjectDefVector[aPopAnimObjectPos.mData.mObjectNum].mSpriteDef =
                            this.mMainAnimDef.mSpriteDefVector[aPopAnimObjectPos.mData.mResNum];
                    }
            ...
            if ((aFrameFlags & GameFramework.resources.PopAnimResource.FRAMEFLAGS_HAS_MOVES) != 0) {
                ...
                for (var aMoveNum = 0; aMoveNum < aNumMoves; aMoveNum++) {
                    ...
                    if ((aFlagsAndObjectNum & GameFramework.resources.PopAnimResource.MOVEFLAGS_HAS_MATRIX) != 0) {
                        ...
                        (aFlagsAndObjectNum & GameFramework.resources.PopAnimResource.MOVEFLAGS_HAS_ROTATE) !=
                        0
                    ) {
                    ...
                    var hasSrcRect =
                        (aFlagsAndObjectNum & GameFramework.resources.PopAnimResource.MOVEFLAGS_HAS_SRCRECT) != 0;
                    ...
                    if (
                        (aFlagsAndObjectNum & GameFramework.resources.PopAnimResource.MOVEFLAGS_HAS_ANIMFRAMENUM) !=
                        0
                    ) {
    ...
    SerializeRead: function GameFramework_resources_PopAnimResource$SerializeRead(theBuffer, theParentStreamer) {
        ...
        for (var anImageNum = 0; anImageNum < aNumImages; anImageNum++) {
            ...
            if (
                Math.abs(anImage.mTransform.a - 1.0) < 0.005 &&
                anImage.mTransform.b == 0.0 &&
                anImage.mTransform.c == 0.0 &&
                Math.abs(anImage.mTransform.d - 1.0) < 0.005 &&
                anImage.mTransform.tx == 0.0 &&
                anImage.mTransform.ty == 0.0
            ) {
            ...
            if (aBarPos != -1) {
                ...
                aResourceStreamer.AddEventListener(
                    ...
                    ss.Delegate.create(anImage, anImage.ImageLoaded)
                );
                aResourceStreamer.AddEventListener(
                    GameFramework.events.Event.COMPLETE,
    ...
    UpdateParticles: function GameFramework_resources_PopAnimResource$UpdateParticles(theSpriteInst, theObjectPos) {
        ...
        if (theSpriteInst.mParticleEffectVector != null) {
            for (var i = 0; i < theSpriteInst.mParticleEffectVector.length; i++) {
                ...
                var aVec = null;
                if (!aParticleEffect.mAttachEmitter) {
                    aVec = theSpriteInst.mCurTransform.transformPoint(
                        new GameFramework.geom.TPoint(aParticleEffect.mXOfs, aParticleEffect.mYOfs)
                    );
                }
    ...
    CalcObjectPos: function GameFramework_resources_PopAnimResource$CalcObjectPos(
        theSpriteInst,
        theObjectPosIdx,
        frozen,
        thePopAnimCalcObjectPosData
    ) {
        ...
        if (this.mInterpolate && !frozen) {
            for (var anOfsIdx = 0; anOfsIdx < 3; anOfsIdx++) {
                var aNextFrame =
                    theSpriteInst.mDef.mFrames[
                        (iFrameNum + this.mOfsTab[anOfsIdx]) % theSpriteInst.mDef.mFrames.length
                    ];
                if (
                    theSpriteInst == this.mMainSpriteInst &&
                    theSpriteInst.mFrameNum >= theSpriteInst.mDef.mWorkAreaStart
                ) {
                    aNextFrame =
                        theSpriteInst.mDef.mFrames[
                            ((iFrameNum + this.mOfsTab[anOfsIdx] - theSpriteInst.mDef.mWorkAreaStart) %
                                (theSpriteInst.mDef.mWorkAreaDuration + 1)) +
                                theSpriteInst.mDef.mWorkAreaStart
                        ];
                } else {
                    aNextFrame =
                        theSpriteInst.mDef.mFrames[
                ...
                if ((aNextFrame.mFrameObjectPosVector.length | 0) > theObjectPosIdx) {
                    ...
                    if (
                        ...
                        this.mNextObjectPos[anOfsIdx].mData.mObjectNum != anObjectPos.mData.mObjectNum
                    ) {
                        this.mNextObjectPos[anOfsIdx] = null;
                    }
                }
                if (this.mNextObjectPos[anOfsIdx] == null) {
                    for (
                        var aCheckObjectPosIdx = 0;
                        aCheckObjectPosIdx < (aNextFrame.mFrameObjectPosVector.length | 0);
                        aCheckObjectPosIdx++
                    ) {
                        if (
                            aNextFrame.mFrameObjectPosVector[aCheckObjectPosIdx] != null &&
                            aNextFrame.mFrameObjectPosVector[aCheckObjectPosIdx].mData.mObjectNum ==
                                anObjectPos.mData.mObjectNum
                        ) {
            ...
            if (
                this.mNextObjectPos[1] != null &&
                (anObjectPos.mTransform != this.mNextObjectPos[1].mTransform ||
                    anObjectPos.mColor != this.mNextObjectPos[1].mColor)
            ) {
                ...
                aCurTransform = GameFramework.Utils.LerpMatrix(
                    anObjectPos.mTransform,
                    this.mNextObjectPos[1].mTransform,
                    anInterp
                );
                if (anObjectPos.mColor != this.mNextObjectPos[1].mColor) {
                    aCurColor = GameFramework.Utils.LerpColor(
                        anObjectPos.mColor,
                        this.mNextObjectPos[1].mColor,
                        anInterp
                    );
                } else {
        ...
        var aMatrix =
            anObjectInst.mTransform != null ? anObjectInst.mTransform.clone() : new GameFramework.geom.Matrix();
        ...
        if (anObjectInst.mIsBlending && this.mBlendTicksTotal != 0 && theSpriteInst == this.mMainSpriteInst) {
            ...
            aCurTransform = GameFramework.Utils.LerpMatrix(
                anObjectInst.mBlendSrcTransform,
                aCurTransform,
                aBlendInterp
            );
    ...
    UpdateTransforms: function GameFramework_resources_PopAnimResource$UpdateTransforms(
        theSpriteInst,
        theTransform,
        theColor,
        parentFrozen
        ...
        for (var anObjectPosIdx = 0; anObjectPosIdx < (aFrame.mFrameObjectPosVector.length | 0); anObjectPosIdx++) {
            ...
            if (anObjectPos != null && anObjectPos.mData.mIsSprite) {
                ...
                this.UpdateTransforms(
                    theSpriteInst.mChildren[anObjectPos.mData.mObjectNum].mSpriteInst,
                    aCurTransform,
                    aCurColor,
                    frozen
                );
            ...
            for (var i = 0; i < (theSpriteInst.mParticleEffectVector.length | 0); i++) {
                ...
                if (aParticleEffect.mAttachEmitter) {
                    if (aParticleEffect.mTransform) {
                        ...
                        aParticleEffect.mEffect.mEmitterTransform.translate(
                            aParticleEffect.mEffect.mWidth / 2.0,
                            aParticleEffect.mEffect.mHeight / 2.0
                        );
    ...
    IncSpriteInstFrame: function GameFramework_resources_PopAnimResource$IncSpriteInstFrame(
        theSpriteInst,
        theObjectPos,
        theFrac
    ) {
        ...
        theSpriteInst.mFrameNum +=
            (theFrac * (theSpriteInst.mDef.mAnimRate / (1000.0 / GameFramework.BaseApp.mApp.mFrameTime))) / aTimeScale;
        if (theSpriteInst == this.mMainSpriteInst) {
            if (!theSpriteInst.mDef.mFrames[theSpriteInst.mDef.mFrames.length - 1].mHasStop) {
                if (
                    (theSpriteInst.mFrameNum | 0) >=
                    theSpriteInst.mDef.mWorkAreaStart + theSpriteInst.mDef.mWorkAreaDuration + 1
                ) {
                ...
                if (
                    (theSpriteInst.mFrameNum | 0) >=
                    theSpriteInst.mDef.mWorkAreaStart + theSpriteInst.mDef.mWorkAreaDuration
                ) {
                    theSpriteInst.mOnNewFrame = true;
                    ...
                    if (theSpriteInst.mDef.mWorkAreaDuration != 0) {
                        this.mAnimRunning = false;
                        var anEvent = new GameFramework.resources.popanim.PopAnimEvent(
                            GameFramework.resources.popanim.PopAnimEvent.STOPPED
                        );
    ...
    PrepSpriteInstFrame: function GameFramework_resources_PopAnimResource$PrepSpriteInstFrame(
        theSpriteInst,
        theObjectPos
    ) {
        var aCurFrame = theSpriteInst.mDef.mFrames[theSpriteInst.mFrameNum | 0];
        ...
        for (var anObjectPosIdx = 0; anObjectPosIdx < (aCurFrame.mFrameObjectPosVector.length | 0); anObjectPosIdx++) {
            ...
            if (anObjectPos != null && anObjectPos.mData.mIsSprite) {
                ...
                if (aSpriteInst != null) {
                    var aPhysFrameNum =
                        (theSpriteInst.mFrameNum | 0) +
                        theSpriteInst.mFrameRepeats * (theSpriteInst.mDef.mFrames.length | 0);
    ...
    DrawSprite: function GameFramework_resources_PopAnimResource$DrawSprite(
        g,
        theSpriteInst,
        theTransform,
        theColor,
        ...
        for (var anObjectPosIdx = 0; anObjectPosIdx < (aFrame.mFrameObjectPosVector.length | 0); anObjectPosIdx++) {
            ...
            if (anObjectInst.mPredrawCallback != null) {
                aCurColor = anObjectInst.mPredrawCallback.invoke(
                    g,
                    theSpriteInst,
                    anObjectInst,
                    theTransform,
            ...
            var aNewColor = GameFramework.gfx.Color.Mult(
                GameFramework.gfx.Color.Mult(aCurColor, theColor),
                anObjectInst.mColorMult
            );
            ...
            if (anObjectPos.mData.mIsSprite) {
                ...
                this.DrawSprite(
                    ...
                    aNewTransform,
                    aNewColor,
                    anObjectPos.mData.mIsAdditive || additive,
                    frozen
                );
            } else {
...
JSFExt_AddInitFunc(function () {
    GameFramework.resources.PopAnimResource.registerClass(
        "GameFramework.resources.PopAnimResource",

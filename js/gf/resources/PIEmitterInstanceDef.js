...
GameFramework.resources.PIEmitterInstanceDef.staticInit =
    function GameFramework_resources_PIEmitterInstanceDef$staticInit() {};

JSFExt_AddInitFunc(function () {
    GameFramework.resources.PIEmitterInstanceDef.registerClass(
        "GameFramework.resources.PIEmitterInstanceDef",
        null,
...
GameFramework.resources.PIEmitterInstanceDef.Value.staticInit =
    function GameFramework_resources_PIEmitterInstanceDef_Value$staticInit() {
...
GameFramework.resources.PIEmitterInstanceDef.Geom.staticInit =
    function GameFramework_resources_PIEmitterInstanceDef_Geom$staticInit() {

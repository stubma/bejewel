...
GameFramework.resources.FontLayer.prototype = {
    ...
    ImageLoaded: function GameFramework_resources_FontLayer$ImageLoaded(e) {
...

        {
            for ($enum1 in this.mCharHashtable) {
                ...
                aFontCharaData.mImageInst = this.mImage.CreateImageInstRect(
                    aFontCharaData.mRectX,
                    aFontCharaData.mRectY,
                    aFontCharaData.mRectWidth,
                    aFontCharaData.mRectHeight
                );
            }
        }
    },
    PushColor: function GameFramework_resources_FontLayer$PushColor(theColor) {
        ...
        this.mColorMult =
            ((((((this.mColorMult >>> 24) & 0xff) * ((theColor >>> 24) & 0xff)) / 255) | 0) << 24) |
            ((((((this.mColorMult >>> 16) & 0xff) * ((theColor >>> 16) & 0xff)) / 255) | 0) << 16) |
            ((((((this.mColorMult >>> 8) & 0xff) * ((theColor >>> 8) & 0xff)) / 255) | 0) << 8) |
            ((((((this.mColorMult >>> 0) & 0xff) * ((theColor >>> 0) & 0xff)) / 255) | 0) << 0);
    },

...
GameFramework.resources.popanim.PopAnimObjectDef.staticInit =
    function GameFramework_resources_popanim_PopAnimObjectDef$staticInit() {};

JSFExt_AddInitFunc(function () {
    GameFramework.resources.popanim.PopAnimObjectDef.registerClass(
        "GameFramework.resources.popanim.PopAnimObjectDef",
        null
    );
});

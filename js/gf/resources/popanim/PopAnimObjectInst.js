...
GameFramework.resources.popanim.PopAnimObjectInst.staticInit =
    function GameFramework_resources_popanim_PopAnimObjectInst$staticInit() {};

JSFExt_AddInitFunc(function () {
    GameFramework.resources.popanim.PopAnimObjectInst.registerClass(
        "GameFramework.resources.popanim.PopAnimObjectInst",
        null
    );
});

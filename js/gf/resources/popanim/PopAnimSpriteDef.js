...
GameFramework.resources.popanim.PopAnimSpriteDef.staticInit =
    function GameFramework_resources_popanim_PopAnimSpriteDef$staticInit() {};

JSFExt_AddInitFunc(function () {
    GameFramework.resources.popanim.PopAnimSpriteDef.registerClass(
        "GameFramework.resources.popanim.PopAnimSpriteDef",
        null
    );
});

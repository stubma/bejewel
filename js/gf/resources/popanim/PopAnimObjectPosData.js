...
GameFramework.resources.popanim.PopAnimObjectPosData.staticInit =
    function GameFramework_resources_popanim_PopAnimObjectPosData$staticInit() {
        GameFramework.resources.popanim.PopAnimObjectPosData.mInstCount = 0;
    };

JSFExt_AddInitFunc(function () {
    GameFramework.resources.popanim.PopAnimObjectPosData.registerClass(
        "GameFramework.resources.popanim.PopAnimObjectPosData",
        null
    );
});

...
GameFramework.resources.popanim.PopAnimCommand.staticInit =
    function GameFramework_resources_popanim_PopAnimCommand$staticInit() {};

JSFExt_AddInitFunc(function () {
    GameFramework.resources.popanim.PopAnimCommand.registerClass(
        "GameFramework.resources.popanim.PopAnimCommand",
        null
    );
});

...
GameFramework.resources.ImageResource.prototype = {
    ...
    get_CenteredImage: function GameFramework_resources_ImageResource$get_CenteredImage() {
        if (this.mCenteredImageResource == null) {
            this.mCenteredImageResource = new GameFramework.gfx.OffsetDrawable(
                this,
                -this.mWidth / 2.0,
                -this.mHeight / 2.0
            );
    ...
    GetRotatedImageEx: function GameFramework_resources_ImageResource$GetRotatedImageEx(
        theAngle,
        theCenterX,
        theCenterY
    ) {
    ...
    CreateImageInstRect: function GameFramework_resources_ImageResource$CreateImageInstRect(
        theSrcX,
        theSrcY,
        theSrcWidth,
        theSrcHeight
...
JSFExt_AddInitFunc(function () {
    GameFramework.resources.ImageResource.registerClass(
        "GameFramework.resources.ImageResource",
        null,
        GameFramework.gfx.IDrawable,

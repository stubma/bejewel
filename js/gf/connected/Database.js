...
GameFramework.connected.Database.prototype = {
    ...
    UpdateDB: function GameFramework_connected_Database$UpdateDB(
        theDBName,
        theCollectionName,
        theSelector,
        theUpdate,
        ...
        var aJSONString = GameFramework.BaseApp.mApp.EncodeJSON(
            Array.Create(
                7,
                null,
                new GameFramework.misc.KeyVal("db", theDBName),
                new GameFramework.misc.KeyVal("collection", theCollectionName),
                new GameFramework.misc.KeyVal("cmd", "update"),
                new GameFramework.misc.KeyVal("flags", aFlags),
                new GameFramework.misc.KeyVal("reqid", this.mRequestId),
                new GameFramework.misc.KeyVal("selector", theSelector),
                new GameFramework.misc.KeyVal("update", theUpdate)
            )
        );
    ...
    UpdateId: function GameFramework_connected_Database$UpdateId(
        theDBName,
        theCollectionName,
        theId,
        theUpdate,
        ...
        return this.UpdateDB(
            theDBName,
            theCollectionName,
            Array.Create(1, null, new GameFramework.misc.KeyVal("_id", theId)),
            theUpdate,
            theFlags
        );
    },
    QueryDB: function GameFramework_connected_Database$QueryDB(
        theDBName,
        theCollectionName,
        theQuery,
        theFieldSelector,
        ...
        var aJSONString = GameFramework.BaseApp.mApp.EncodeJSON(
            Array.Create(
                ...
                new GameFramework.misc.KeyVal("db", theDBName),
                new GameFramework.misc.KeyVal("collection", theCollectionName),
                new GameFramework.misc.KeyVal("cmd", aCmd),
                new GameFramework.misc.KeyVal("reqid", this.mRequestId),
                new GameFramework.misc.KeyVal("query", theQuery),
                new GameFramework.misc.KeyVal("fields", theFieldSelector)
            )
        );
    ...
    QueryId: function GameFramework_connected_Database$QueryId(
        theDBName,
        theCollectionName,
        theId,
        theFieldSelector,
        ...
        return this.QueryDB(
            theDBName,
            theCollectionName,
            new GameFramework.misc.KeyVal("_id", theId),
            theFieldSelector,
            theFlags
        );
    },

...
function JSFExt_CopyTexBits(theGLTex, theSrcX, theSrcY, theWidth, theHeight, theColorImage, theAlphaImage, theDestX, theDestY) {
...
function JSFExt_CreateGLTexComb(theColorImage, theAlphaImage) {
	...
	JSFExt_CopyToImageData(aCompositeImageData, 0, 0, theColorImage.width, theColorImage.height, theColorImage, theAlphaImage, 0, 0);

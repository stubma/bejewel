...
GameFramework.gfx.Color.CreateFromInt = function GameFramework_gfx_Color$CreateFromInt(theColorInt) {
    return new GameFramework.gfx.Color(
        ((theColorInt >>> 16) | 0) & 0xff,
        ((theColorInt >>> 8) | 0) & 0xff,
        (theColorInt | 0) & 0xff,
        ((theColorInt >>> 24) | 0) & 0xff
    );
};
GameFramework.gfx.Color.CreateFromIntAlpha = function GameFramework_gfx_Color$CreateFromIntAlpha(
    theColorInt,
    theAlpha
) {
    return new GameFramework.gfx.Color(
...
GameFramework.gfx.Color.Mult = function GameFramework_gfx_Color$Mult(theColor, theColorMult) {
    ...
    var aResult =
        ((((((theColor >>> 24) & 0xff) * ((theColorMult >>> 24) & 0xff)) / 255) | 0) << 24) |
        ((((((theColor >>> 16) & 0xff) * ((theColorMult >>> 16) & 0xff)) / 255) | 0) << 16) |
        ((((((theColor >>> 8) & 0xff) * ((theColorMult >>> 8) & 0xff)) / 255) | 0) << 8) |
        ((((theColor & 0xff) * (theColorMult & 0xff)) / 255) | 0);
    return aResult;
};

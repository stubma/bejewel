...
GameFramework.gfx.Graphics.WordWrapHelper = function GameFramework_gfx_Graphics$WordWrapHelper(
    g,
    theFont,
    theString,
    theX,
    ...
    while (aCurPos < theString.length) {
        ...
        if (aCurWidth > theWidth) {
            ...
            if (aSpacePos != -1) {
                if (g != null) {
                    g.DrawStringEx(
                        theString.substr(aLineStartPos, aSpacePos - aLineStartPos),
                        theX,
                        theY + aYOffset,
                        theWidth,
                        theJustification
...
GameFramework.gfx.Graphics.GetDrawStringData = function GameFramework_gfx_Graphics$GetDrawStringData(
    theString,
    theFont,
    theWidth,
    theJustification,
    ...
    if (theTextOverflowMode == GameFramework.gfx.ETextOverflowMode.Draw) {
        ...
        GameFramework.gfx.Graphics.WordWrapHelper(
            null,
            theFont,
            theString,
            0,
...
GameFramework.gfx.Graphics.prototype = {
    ...
    PushColor: function GameFramework_gfx_Graphics$PushColor(theColor) {
        ...
        if (this.mColorComponents != null) {
            return this.PushColorComponents(
                ((this.mColor >>> 24) | 0) & 0xff,
                ((this.mColor >>> 16) | 0) & 0xff,
                ((this.mColor >>> 8) | 0) & 0xff,
                ((this.mColor >>> 0) | 0) & 0xff
            );
        } else {
            ...
            if (this.mColor == 0xffffffff) {
                ...
                this.mColor =
                    ((((((this.mColor >>> 24) & 0xff) * ((theColor >>> 24) & 0xff)) / 255) | 0) << 24) |
                    ((((((this.mColor >>> 16) & 0xff) * ((theColor >>> 16) & 0xff)) / 255) | 0) << 16) |
                    ((((((this.mColor >>> 8) & 0xff) * ((theColor >>> 8) & 0xff)) / 255) | 0) << 8) |
                    ((((((this.mColor >>> 0) & 0xff) * ((theColor >>> 0) & 0xff)) / 255) | 0) << 0);
            }
    ...
    SetColor: function GameFramework_gfx_Graphics$SetColor(theColor) {
        if (this.mColorComponents != null) {
            if (this.mColorComponentVector.length == 0) {
                this.mColorComponents = Array.Create(
                    4,
                    0,
                    ((this.mColor >>> 24) | 0) & 0xff,
                    ((this.mColor >>> 16) | 0) & 0xff,
    ...
    DrawButton: function GameFramework_gfx_Graphics$DrawButton(theImage, theX, theY, theWidth, theCel) {
        ...
        if (aButtonPieces == null) {
            aButtonPieces = Array.Create(
                3,
                null,
                theImage.CreateImageInstCel(theCel),
                theImage.CreateImageInstCel(theCel),
                theImage.CreateImageInstCel(theCel)
            );
        ...
        this.PushScale(
            (theWidth - aLogChunkWidth * 2) / (aButtonPieces[1].mSrcWidth / this.mScale),
            1.0,
            theX + aLogChunkWidth,
            theY
        );
    ...
    DrawImageBox: function GameFramework_gfx_Graphics$DrawImageBox(theImage, theX, theY, theWidth, theHeight, theCel) {
        ...
        if (hasVertCenter) {
            this.PushScale(
                1.0,
                (theHeight - aLogChunkHeight * 2) / (aButtonPieces[3].mSrcHeight / this.mScale),
                theX,
                theY + aLogChunkHeight
            );
            ...
            if (hasHorzCenter) {
                this.PushScale(
                    (theWidth - aLogChunkWidth * 2) / (aButtonPieces[7].mSrcWidth / this.mScale),
                    (theHeight - aLogChunkHeight * 2) / (aButtonPieces[4].mSrcHeight / this.mScale),
                    theX + aLogChunkWidth,
                    theY + aLogChunkHeight
                );
            ...
            this.PushScale(
                1.0,
                (theHeight - aLogChunkHeight * 2) / (aButtonPieces[5].mSrcHeight / this.mScale),
                theX + theWidth - aLogChunkWidth,
                theY + aLogChunkHeight
            );
        ...
        if (hasHorzCenter) {
            this.PushScale(
                ...
                1.0,
                theX + aLogChunkWidth,
                theY + theHeight - aLogChunkHeight
            );
    ...
    DrawStringEx: function GameFramework_gfx_Graphics$DrawStringEx(
        theString,
        theX,
        theY,
        theWidth,
        ...
        if (theTextOverflowMode != GameFramework.gfx.ETextOverflowMode.Wrap) {
            ...
            for (;;) {
                ...
                this.DrawStringEx(
                    theString.substr(aCurPos, aBrPos - aCurPos),
                    theX,
                    theY,
                    theWidth,
                    theJustification,

...
GameFramework.widgets.ClassicWidgetAppState.prototype = {
    ...
    FlushDeferDraws: function GameFramework_widgets_ClassicWidgetAppState$FlushDeferDraws() {
        for (var i = 0; i < this.mDeferDraws.length; i++) {
            ...
            var _t1 = this.mGraphics.PushTranslate(
                aClassicWidget.mLastDrawX - this.mGraphics.mMatrix.tx,
                aClassicWidget.mLastDrawY - this.mGraphics.mMatrix.ty
            );
            try {
    ...
    RehupMouse: function GameFramework_widgets_ClassicWidgetAppState$RehupMouse() {
        var aWidgetOver = this.mRootWidget.FindWidget(
            this.mLastMouseX - this.mRootWidget.mX,
            this.mLastMouseY - this.mRootWidget.mY
        );
...
GameFramework.widgets.ClassicWidgetAppState.staticInit =
    function GameFramework_widgets_ClassicWidgetAppState$staticInit() {};

JSFExt_AddInitFunc(function () {
    GameFramework.widgets.ClassicWidgetAppState.registerClass(
        "GameFramework.widgets.ClassicWidgetAppState",
        GameFramework.events.EventDispatcher,
        GameFramework.IAppState
    );
});

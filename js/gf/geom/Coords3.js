...
GameFramework.geom.Coords3.prototype = {
    ...
    Enter: function GameFramework_geom_Coords3$Enter(inCoords) {
        return new GameFramework.geom.Coords3(
            this.t.Enter$2(inCoords),
            this.r.Enter(inCoords.r),
            this.s.Div(inCoords.s)
        );
    },
    Leave: function GameFramework_geom_Coords3$Leave(inCoords) {
        return new GameFramework.geom.Coords3(
            this.t.Leave$2(inCoords),
            this.r.Leave(inCoords.r),
            this.s.Mult(inCoords.s)
        );
    },

...
GameFramework.gfx.JSGraphics3D.prototype = {
    ...
    SetTexture: function GameFramework_gfx_JSGraphics3D$SetTexture(inTextureIndex, inImage) {
        ...
        if (inImage != null) {
            ...
            gGL.texParameteri(
                gGL.TEXTURE_2D,
                gGL.TEXTURE_WRAP_S,
                this.mWrapU[inTextureIndex] ? gGL.REPEAT : gGL.CLAMP_TO_EDGE
            );
            gGL.texParameteri(
                gGL.TEXTURE_2D,
                gGL.TEXTURE_WRAP_T,
                this.mWrapV[inTextureIndex] ? gGL.REPEAT : gGL.CLAMP_TO_EDGE
            );
        } else {
    ...
    SetBackfaceCulling: function GameFramework_gfx_JSGraphics3D$SetBackfaceCulling(
        cullClockwise,

    ...
    DrawEx: function GameFramework_resources_JSImageInst$DrawEx(g, theMatrix, theX, theY, theCel) {
        ...
        if (GameFramework.JSBaseApp.mJSApp.mUseGL) {
            ...
            JSFExt_GLDraw(
                ...
                aNewMatrix.c,
                aNewMatrix.d,
                this.mSrcX + this.mSource.mTexOfsX,
                this.mSrcY + this.mSource.mTexOfsY,
                this.mSrcWidth,
                this.mSrcHeight,
                this.mSource.mTexWidth,
                this.mSource.mTexHeight,
                this.mAdditive,
                g.mColor
            );
            //-JS
            ...
            //JS
            JSFExt_CanvasDraw(
                this.mSource.mHTMLImageResource,
                aGlobalAlpha,
                this.mAdditive,
                aNewMatrix.a,
                aNewMatrix.b,
                ...
                aNewMatrix.tx,
                aNewMatrix.ty,
                this.mSource.mTexOfsX + this.mSrcX,
                this.mSource.mTexOfsY + this.mSrcY,
                this.mSrcWidth,
                this.mSrcHeight
            );
            //-JS
...
JSFExt_AddInitFunc(function () {
    GameFramework.resources.JSImageInst.registerClass(
        "GameFramework.resources.JSImageInst",

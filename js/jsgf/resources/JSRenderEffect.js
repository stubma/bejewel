...
GameFramework.resources.JSRenderEffect.prototype = {
    ...
    ReadData: function GameFramework_resources_JSRenderEffect$ReadData(theDataBuffer) {
        ...
        this.mTechniqueReadData = new GameFramework.resources.JSRenderEffectBlock(
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt()
        );
        this.mAnnotationData = new GameFramework.resources.JSRenderEffectBlock(
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt()
        );
        this.mStringsData = new GameFramework.resources.JSRenderEffectBlock(
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt()
        );
        this.mValuesData = new GameFramework.resources.JSRenderEffectBlock(
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt()
        );
        this.mPassesData = new GameFramework.resources.JSRenderEffectBlock(
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt()
        );
        this.mSettingsData = new GameFramework.resources.JSRenderEffectBlock(
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt()
        );
        this.mShadersData = new GameFramework.resources.JSRenderEffectBlock(
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt(),
            theDataBuffer.ReadInt()
        );
        ...
        for (var aTechniqueIdx = 0; aTechniqueIdx < this.mTechniqueReadData.mCount; aTechniqueIdx++) {
            ...
            for (var aPassIdx = 0; aPassIdx < aNumPasses; aPassIdx++) {
                ...
                for (var aSettingIdx = 0; aSettingIdx < aPassNumSettings; aSettingIdx++) {
                    this.mDataBuffer.set_Position(
                        this.mSettingsData.mOffset + (aPassSettingStartIdx + aSettingIdx) * 4 * 5
                    );
    ...
    SetMatrixPhys: function GameFramework_resources_JSRenderEffect$SetMatrixPhys(theName, theTransform) {
        //JS
        JSFExt_SetShaderUniform4fv(theName, [
            theTransform.m[(0, 0)],
            theTransform.m[(0, 1)],
            theTransform.m[(0, 2)],
            theTransform.m[(0, 3)],
...
JSFExt_AddInitFunc(function () {
    GameFramework.resources.JSRenderEffect.registerClass(
        "GameFramework.resources.JSRenderEffect",

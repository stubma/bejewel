...
GameFramework.resources.JSResourceManager.prototype = {
    ...
    ParseRenderEffectData: function GameFramework_resources_JSResourceManager$ParseRenderEffectData(
        theResourceStreamer
    ) {
    ...
    ParseMeshResourceData: function GameFramework_resources_JSResourceManager$ParseMeshResourceData(
        theResourceStreamer
    ) {
        ...
        if (theResourceStreamer.mResType == GameFramework.resources.ResourceManager.RESTYPE_IMAGE) {
            ...
            if (theResourceStreamer.mBaseRes != null && theResourceStreamer.mBaseRes.mRTParent != null) {
                ...
                if (aRTParent == null) {
                    ...
                    aRTParent.mCompositeImageData = JSFExt_CreateCompositeImageData(
                        aRTParentBaseRes.mWidth,
                        aRTParentBaseRes.mHeight
                    );
                    //-JS
                ...
                JSFExt_CopyToImageData(
                    aRTParent.mCompositeImageData,
                    theResourceStreamer.mBaseRes.mAtlasX,
                    theResourceStreamer.mBaseRes.mAtlasY,
                    theResourceStreamer.mBaseRes.mAtlasWidth,
                    theResourceStreamer.mBaseRes.mAtlasHeight,
                    aParent.mColorImage,
                    aParent.mAlphaImage,
                    theResourceStreamer.mBaseRes.mAtlasRTX,
                    theResourceStreamer.mBaseRes.mAtlasRTY
                );
                //-JS
                ...
                anImageResource.mPhysCelWidth =
                    (theResourceStreamer.mBaseRes.mAtlasWidth / theResourceStreamer.mBaseRes.mCols) | 0;
                anImageResource.mPhysCelHeight =
                    (theResourceStreamer.mBaseRes.mAtlasHeight / theResourceStreamer.mBaseRes.mRows) | 0;
            ...
            if (theResourceStreamer.mBaseRes == null) {
                anImageResource.mWidth =
                    (anImageResource.mPhysCelWidth / GameFramework.BaseApp.mApp.mGraphics.mScale) | 0;
                anImageResource.mHeight =
                    (anImageResource.mPhysCelHeight / GameFramework.BaseApp.mApp.mGraphics.mScale) | 0;
            }
            anImageResource.mAdjustedWidth =
                anImageResource.mPhysCelWidth / GameFramework.BaseApp.mApp.mGraphics.mScale;
            anImageResource.mAdjustedHeight =
                anImageResource.mPhysCelHeight / GameFramework.BaseApp.mApp.mGraphics.mScale;
...
GameFramework.resources.JSResourceManager.staticInit =
    function GameFramework_resources_JSResourceManager$staticInit() {};

JSFExt_AddInitFunc(function () {
    GameFramework.resources.JSResourceManager.registerClass(
        "GameFramework.resources.JSResourceManager",

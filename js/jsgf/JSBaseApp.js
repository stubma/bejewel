...
GameFramework.JSBaseApp.prototype = {
            ...
            if (aConnectedRequest.mLinkedRequestCount == 0) {
                if (aConnectedRequest.mGetterObject == null) {
                    if (
                        ...
                        //JS
                        aConnectedRequest.mGetterObject = $["get"](
                            aConnectedRequest.mRequest,
                            null,
                            function (data) {
                        ...
                        //JS
                        aConnectedRequest.mGetterObject = $["post"](
                            aConnectedRequest.mRequest,
                            aConnectedRequest.mRequestParams,
                            function (data) {
                                aConnectedRequest.mResult = data;
                            },
                            "text"
    ...
    Update: function GameFramework_JSBaseApp$Update() {
        ...
        for (var anIdx = 0; anIdx < this.mResourceStreamerList.length; anIdx++) {
            ...
            if (aResourceStreamer.mResultData == null && aResourceStreamer.mPath != null) {
                if (aResourceStreamer.mResType === GameFramework.resources.ResourceManager.RESTYPE_IMAGE) {
                    if (aResourceStreamer.mBaseRes != null && aResourceStreamer.mBaseRes.mParent != null) {
                        var anImageResource = this.mResourceManager.GetImageResourceById(
                            aResourceStreamer.mBaseRes.mParent
                        );
                        if (
                            anImageResource != null &&
                            aResourceStreamer.mResourcesLoaded != aResourceStreamer.mResourceCount
                        ) {
                            aResourceStreamer.mResourcesLoaded++;
                        }
                    } else {
                        if (aResourceStreamer.mBaseRes != null && aResourceStreamer.mBaseRes.mIsNotRuntimeImage) {
                            aResourceStreamer.mResultData = JSFExt_LoadImageSub(
                                aResourceStreamer,
                            ...
                            aResourceStreamer.mResultData = JSFExt_LoadImage(
                                aResourceStreamer,
                                aResourceStreamer.mPath ? this.mPathPrefix + aResourceStreamer.mPath : null,
                                aResourceStreamer.mPath2 ? this.mPathPrefix + aResourceStreamer.mPath2 : null
                            );
                    ...
                    aResourceStreamer.mResType === GameFramework.resources.ResourceManager.RESTYPE_FONT ||
                    ...
                    if (aResourceStreamer.mPath.startsWith("!ref:")) {
                        ...
                        if (anAtIdx != -1) {
                            ...
                            var aGroupBinDataName = aResourceStreamer.mPath.substr(
                                anAtIdx + 1,
                                aColonPos - anAtIdx - 1
                            );
                    ...
                    if (aResourceStreamer.mPath.indexOf(".json") !== -1) {
                        aRequest = $["get"](
                            this.mPathPrefix + aResourceStreamer.mPath,
                            null,
                            ss.Delegate.create(this, this.ResourceStreamerAjaxCallback),
                            "text"
                        );
                    } else {
                        aRequest = $["get"](
            ...
            if (
                aResourceStreamer.mFailed ||
                (aResourceStreamer.mResourcesLoaded == aResourceStreamer.mResourceCount &&
                    !GameFramework.BaseApp.mApp.mResourceManager.mStreamingPaused)
            ) {
        ...
        if (
            hasSounds &&
            !hasNonSounds &&
            !this.mHasLoadedSound &&
            GameFramework.Utils.GetRunningMilliseconds() - this.mLastResourceLoadedTick >= 30000
        ) {
    ...
    ResourceStreamerCompletedCallback: function GameFramework_JSBaseApp$ResourceStreamerCompletedCallback(
        theData,
        theResourceStreamer
    ) {
        this.mLastResourceLoadedTick = GameFramework.Utils.GetRunningMilliseconds();
    ...
    ResourceStreamerAjaxCallback: function GameFramework_JSBaseApp$ResourceStreamerAjaxCallback(
        theData,
        theTextStatus,
        theRequest
    ) {
                ...
                if (aChar == 92) {
                    ...
                    if (aCurName == null && Type.tryCast(theDataObject, Object)) {
                        if (aDataStart == -1) {
                            ...
                            aCurName = this.JSONUnslash(
                                theJSONString.substr(aDataStart, theHelperData.mStrIdx - aDataStart - 1)
                            );
                            aDataStart = -1;
                        }
                    } else {
                    ...
                    aChar != 91 &&
                    aChar != 123 &&
                    !GameFramework.Utils.IsWhitespace(aChar)
                ) {
    ...
    DecodeJSON: function GameFramework_JSBaseApp$DecodeJSON(theJSONString, theDataObject) {
        ...
        while (
            aJSONHelperData.mStrIdx < theJSONString.length &&
            GameFramework.Utils.IsWhitespace(theJSONString.charCodeAt(aJSONHelperData.mStrIdx))
        ) {

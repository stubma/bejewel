...
Game.ColorCycle.prototype = {
    ...
    Update: function Game_ColorCycle$Update() {
        ...
        this.mColor = GameFramework.gfx.Color.RGBAToInt(
            (aFraction * aColor[1].mRed + (1.0 - aFraction) * aColor[0].mRed) | 0,
            (aFraction * aColor[1].mGreen + (1.0 - aFraction) * aColor[0].mGreen) | 0,
            (aFraction * aColor[1].mBlue + (1.0 - aFraction) * aColor[0].mBlue) | 0,
            (this.mAlpha * (aFraction * aColor[1].mAlpha + (1.0 - aFraction) * aColor[0].mAlpha)) | 0
        );
    },
...
Game.ColorCycle.staticInit = function Game_ColorCycle$staticInit() {
    Game.ColorCycle.gCycleColors = Array.Create(
        6,
        null,
        0xffff0000,
        0xffffff00,

Game.HintDialog = function Game_HintDialog(theHeader, theText, theHasButton, theIsModal, disableBox) {
    ...
    Game.HintDialog.initializeBase(this, [
        theIsModal ? Game.Resources["IMAGE_DIALOG_BACKGROUND"] : Game.Resources["IMAGE_DIALOG_HEADERLESS_BKG"],
        Game.Resources["IMAGE_DIALOG_BUTTON"],
        Game.DM.EDialog.TUTORIAL,
        true,
        theHeader,
        theText,
        "",
        theHasButton ? GameFramework.widgets.Dialog.BUTTONS_FOOTER : GameFramework.widgets.Dialog.BUTTONS_NONE,
    ]);
    ...
    if (this.mWantDisableBox) {
        ...
        this.mNoHintsCheckbox.AddEventListener(
            GameFramework.widgets.WidgetEvent.CHECKBOX_CHECKED,
            ss.Delegate.create(this, this.handleCheckboxChecked)
        );

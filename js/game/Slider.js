...
Game.Slider.prototype = {
    ...
    Draw: function Game_Slider$Draw(g) {
        ...
        if (this.mHorizontal && this.mThumbImage != null) {
            g.DrawImage(
                this.mThumbImage,
                (this.mVal * (this.mWidth - this.mThumbImage.mWidth)) | 0,
                (this.mHeight - this.mThumbImage.mHeight) / 2
            );
        } else if (!this.mHorizontal && this.mThumbImage != null) {
            g.DrawImage(
                this.mThumbImage,
                (this.mWidth - this.mThumbImage.mWidth) / 2,
                (this.mVal * (this.mHeight - this.mThumbImage.mHeight)) | 0
            );

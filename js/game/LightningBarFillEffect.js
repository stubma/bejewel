...
Game.LightningBarFillEffect.prototype = {
    ...
    Update: function Game_LightningBarFillEffect$Update() {
        ...
        if (this.mFXManager.mBoard.mUpdateCnt % 2 == 0 || isNew) {
            ...
            for (
                ...
                aLightningPointNum < Game.LightningBarFillEffect.NUM_BARFILL_LIGTNING_POINTS;
                aLightningPointNum++
            ) {
                ...
                var aCenterX =
                    ...
                    anEndX * aDistAlong +
                    aCenterMult * (GameFramework.Utils.GetRandFloat() * 60.0);
                var aCenterY =
                ...
                if (
                    aLightningPointNum == 0 ||
                    aLightningPointNum == Game.LightningBarFillEffect.NUM_BARFILL_LIGTNING_POINTS - 1
                ) {
                    aPoint.x = aCenterX;
                    aPoint.y = aCenterY;
                    aPointR.x = aCenterX;
    ...
    Draw: function Game_LightningBarFillEffect$Draw(g) {
        ...
        if (GameFramework.BaseApp.mApp.get_Is3D()) {
            var aTriVertices = Array.Create2D(
                (Game.LightningBarFillEffect.NUM_BARFILL_LIGTNING_POINTS - 1) * 2,
                3,
                null
            );
            ...
            for (
                ...
                aLightningPointNum_2 < Game.LightningBarFillEffect.NUM_BARFILL_LIGTNING_POINTS - 1;

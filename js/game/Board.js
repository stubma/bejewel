...
Game.Board.ParseGridLayout = function Game_Board$ParseGridLayout(
    theBoard,
    theStr,
    outGrid,
    theEnforceStdGridSize,
    theColCount,
    theRowCount
) {
    var count = 0;
    for (var loc = 0; loc < theStr.length; ++loc) {
        if (GameFramework.Utils.IsLetterAt(theStr, loc)) {
            ...
            grid.At(((count - 1) / theBoard.mRowCount) | 0 | 0, (count - 1) % theBoard.mColCount).mAttr =
                GameFramework.Utils.GetCharAt(theStr, loc);
            ...
            if (theEnforceStdGridSize && (outGrid.length == 0 || count >= theBoard.mColCount * theBoard.mRowCount)) {
                ...
                !theEnforceStdGridSize &&
                (outGrid.length == 0 ||
                    (((count | 0) / theBoard.mColCount) | 0) >= outGrid[outGrid.length - 1].GetRowCount())
            ) {
                if (outGrid.length == 0) {
            ...
            outGrid[outGrid.length - 1]
                .At((count / theBoard.mRowCount) | 0 | 0, count % theBoard.mColCount)
                .mBack.push(GameFramework.Utils.ToInt(theStr.substr(loc, 1)));
            ++count;
        } else if (theStr.substr(loc, 1) == "'") {
            var anEndPos = theStr.indexOf(String.fromCharCode(39), loc + 1);
            var aGridTileData = outGrid[outGrid.length - 1].At(
                ((count - 1) / theBoard.mRowCount) | 0 | 0,
                (count - 1) % theBoard.mColCount
            );
...
Game.Board.prototype = {
    ...
    InitUI: function Game_Board$InitUI() {
        if (this.mUiConfig == Game.Board.EUIConfig.Standard || this.mUiConfig == Game.Board.EUIConfig.WithReset) {
            if (this.mHintButton == null) {
                ...
                this.mHintButton.AddEventListener(
                    GameFramework.widgets.WidgetEvent.CLICKED,
                    ss.Delegate.create(this, this.HintButtonPressed)
                );
                this.mHintButton.AddEventListener(
                    GameFramework.widgets.WidgetEvent.MOUSE_DOWN,
                    ss.Delegate.create(this, this.ButtonDown)
                );
                ...
                this.mHintButton.Resize(
                    this.mWidescreenX + this.mHintButton.mButtonImage.mOffsetX + this.GetLeftUIOffsetX(),
                    this.mHintButton.mButtonImage.mOffsetY,
                    this.mHintButton.mButtonImage.mWidth,
                    this.mHintButton.mButtonImage.mHeight
                );
            ...
            if (this.mMenuButton == null) {
                ...
                this.mMenuButton.AddEventListener(
                    GameFramework.widgets.WidgetEvent.CLICKED,
                    ss.Delegate.create(this, this.MenuButtonPressed)
                );
                this.mMenuButton.AddEventListener(
                    GameFramework.widgets.WidgetEvent.MOUSE_DOWN,
                    ss.Delegate.create(this, this.ButtonDown)
                ...
                this.mMenuButton.Resize(
                    this.mWidescreenX + this.mMenuButton.mButtonImage.mOffsetX + this.GetLeftUIOffsetX(),
                    this.mMenuButton.mButtonImage.mOffsetY,
                    this.mMenuButton.mButtonImage.mWidth,
                    this.mMenuButton.mButtonImage.mHeight
                );
            ...
            case Game.Board.EUIConfig.WithReset: {
                if (this.mResetButton == null) {
                    ...
                    this.mResetButton.AddEventListener(
                        GameFramework.widgets.WidgetEvent.CLICKED,
                        ss.Delegate.create(this, this.ResetButtonPressed)
                    );
                    this.mResetButton.AddEventListener(
                        GameFramework.widgets.WidgetEvent.MOUSE_DOWN,
                        ss.Delegate.create(this, this.ButtonDown)
                    ...
                    this.mResetButton.Resize(
                        this.mWidescreenX + this.mResetButton.mButtonImage.mOffsetX + this.GetLeftUIOffsetX(),
                        this.mResetButton.mButtonImage.mOffsetY,
                        this.mResetButton.mButtonImage.mWidth,
                        this.mResetButton.mButtonImage.mHeight
                    );
    ...
    CanPlay: function Game_Board$CanPlay() {
...

        {
            ...
            for (var $enum4 = 0; $enum4 < $srcArray4.length; $enum4++) {
                ...
                if (
                    aPiece != null &&
                    (aPiece.IsFlagSet(Game.Piece.EFlag.BOMB) || aPiece.IsFlagSet(Game.Piece.EFlag.REALTIME_BOMB)) &&
                    aPiece.mCounter == 0
                ) {
                    return false;
                }
    ...
    IsGameSuspended: function Game_Board$IsGameSuspended() {
        return (
            this.mReadyDelayCount > 0 ||
            this.mTimeExpired ||
            this.mLightningStorms.length > 0 ||
            Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.OPTIONS) != null ||
            this.mTutorialMgr.WantsBlockTimer() ||
            (Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.TUTORIAL) != null &&
                Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.TUTORIAL).IsModal())
        );
    },
    CanPiecesFall: function Game_Board$CanPiecesFall() {
        return (
            (Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.TUTORIAL) == null ||
                !Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.TUTORIAL).mIsModal) &&
            this.mGemFallDelay == 0 &&
            this.mLightningStorms.length == 0
        );
    },
    IsGamePaused: function Game_Board$IsGamePaused() {
        return (
            (this.mUserPaused ||
                Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.OPTIONS) != null ||
                Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.RESET) != null ||
                Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.MAIN_MENU_CONFIRM) != null) &&
            this.WantsHideOnPause()
        );
    },
    ...
    NewGame: function Game_Board$NewGame() {
        ...
        Game.BejApp.mBejApp.SubmitStandardMetrics("game_started", [
            new GameFramework.misc.KeyVal("GameId", this.mGameId),
        ]);
        this.mUserPaused = false;
        this.mVisPausePct = 0;
            ...
            if (thePieceDestroyed) {
                if (!thePiece.IsFlagSet(Game.Piece.EFlag.DIG)) {
                    ...
                    if (thePiece.mMoveCreditId != -1) {
                        this.MaxStat(
                            Game.DM.EStat.BIGGESTMOVE,
                            this.GetMoveStat(thePiece.mMoveCreditId, Game.DM.EStat.POINTS)
                        );
                        this.MaxStat(
                            Game.DM.EStat.BIGGEST_GEMS_CLEARED,
                            this.GetMoveStat(thePiece.mMoveCreditId, Game.DM.EStat.GEMS_CLEARED)
                        );
                    }
                }
    ...
    AddToStatEx: function Game_Board$AddToStatEx(theStatNum, theNumber, theMoveCreditId, addToProfile) {
        ...
        if (addToProfile) {
            Game.BejApp.mBejApp.mProfile.mStats[theStatNum | 0] =
                Game.BejApp.mBejApp.mProfile.mStats[theStatNum | 0] + theNumber;
        ...
        if (theMoveCreditId != -1) {
            for (var aMoveDataIdx = 0; aMoveDataIdx < (this.mMoveDataVector.length | 0); aMoveDataIdx++) {
                if (this.mMoveDataVector[aMoveDataIdx].mMoveCreditId == theMoveCreditId) {
                    this.mMoveDataVector[aMoveDataIdx].mStats[theStatNum | 0] =
                        this.mMoveDataVector[aMoveDataIdx].mStats[theStatNum | 0] + theNumber;
                }
            }
        }
    },
    ...
    MaxStatCred: function Game_Board$MaxStatCred(theStatNum, theNumber, theMoveCreditId) {
        ...
        Game.BejApp.mBejApp.mProfile.mStats[theStatNum | 0] =
            Math.max(Game.BejApp.mBejApp.mProfile.mStats[theStatNum | 0], theNumber) | 0;
        if (theMoveCreditId != -1) {
            for (var aMoveDataIdx = 0; aMoveDataIdx < (this.mMoveDataVector.length | 0); aMoveDataIdx++) {
                if (this.mMoveDataVector[aMoveDataIdx].mMoveCreditId == theMoveCreditId) {
                    this.mMoveDataVector[aMoveDataIdx].mStats[theStatNum | 0] =
                        Math.max(this.mMoveDataVector[aMoveDataIdx].mStats[theStatNum | 0], theNumber) | 0;
                }
            }
        }
    },
    ...
    SubmitStats: function Game_Board$SubmitStats(endOfGame) {
        ...
        var aData = [
            new GameFramework.misc.KeyVal("IsSlow", Game.BejApp.mBejApp.mIsSlow),
            new GameFramework.misc.KeyVal("MusicVolume", Game.BejApp.mBejApp.mProfile.mMusicVolume),
            new GameFramework.misc.KeyVal("SfxVolume", Game.BejApp.mBejApp.mProfile.mSfxVolume),
            new GameFramework.misc.KeyVal("GameId", this.mGameId),
            new GameFramework.misc.KeyVal("GameMode", this.GetGameType()),
            new GameFramework.misc.KeyVal("GameTimePlayed", aStats[Game.DM.EStat.SECONDS_PLAYED | 0] * 10),
            new GameFramework.misc.KeyVal("WasGameCompleted", this.mGameFinished),
            new GameFramework.misc.KeyVal(
                "FpsAverage",
                (aStats[Game.DM.EStat.FPS_SAMPLE_TOTAL | 0] / Math.max(1, aStats[Game.DM.EStat.FPS_SAMPLE_COUNT | 0])) |
                    0
            ),
            new GameFramework.misc.KeyVal("FpsLow", aStats[Game.DM.EStat.FPS_MIN | 0]),
            new GameFramework.misc.KeyVal("FpsHigh", aStats[Game.DM.EStat.FPS_MAX | 0]),
            new GameFramework.misc.KeyVal("Level", Math.max(this.mPointMultiplier, this.mLevel + 1)),
            new GameFramework.misc.KeyVal("Points", this.mPoints),
            new GameFramework.misc.KeyVal("SpeedPoints", aSpeedPoints),
            new GameFramework.misc.KeyVal("HurrahPoints", aHurrahPoints),
            new GameFramework.misc.KeyVal("MatchPoints", aMatchPoints),
            new GameFramework.misc.KeyVal("GemsCleared", aStats[Game.DM.EStat.GEMS_CLEARED | 0]),
            new GameFramework.misc.KeyVal("FlamegemsCleared", aStats[Game.DM.EStat.FLAMEGEMS_USED | 0]),
            new GameFramework.misc.KeyVal("StargemsCleared", aStats[Game.DM.EStat.LASERGEMS_USED | 0]),
            new GameFramework.misc.KeyVal("HypergemsCleared", aStats[Game.DM.EStat.HYPERCUBES_USED | 0]),
            new GameFramework.misc.KeyVal("SupernovagemsCleared", aStats[Game.DM.EStat.SUPERNOVAS_USED | 0]),
            new GameFramework.misc.KeyVal("FlamegemsMade", aStats[Game.DM.EStat.FLAMEGEMS_MADE | 0]),
            new GameFramework.misc.KeyVal("StargemsMade", aStats[Game.DM.EStat.LASERGEMS_MADE | 0]),
            new GameFramework.misc.KeyVal("HypergemsMade", aStats[Game.DM.EStat.HYPERCUBES_MADE | 0]),
            new GameFramework.misc.KeyVal("SupernovagemsMade", aStats[Game.DM.EStat.SUPERNOVAS_MADE | 0]),
            new GameFramework.misc.KeyVal("NumMoves", aStats[Game.DM.EStat.NUM_MOVES | 0]),
            new GameFramework.misc.KeyVal("NumMovesDrag", aStats[Game.DM.EStat.NUM_MOVES_DRAG | 0]),
            new GameFramework.misc.KeyVal("NumMovesClick", aStats[Game.DM.EStat.NUM_MOVES_CLICK | 0]),
            new GameFramework.misc.KeyVal("NumGoodMoves", aStats[Game.DM.EStat.NUM_GOOD_MOVES | 0]),
            new GameFramework.misc.KeyVal("NumMatches", aStats[Game.DM.EStat.MATCHES | 0]),
            new GameFramework.misc.KeyVal("TotalXP", Game.BejApp.mBejApp.mProfile.mOfflineRankPoints),
            new GameFramework.misc.KeyVal("PlayerRank", Game.BejApp.mBejApp.mProfile.mOfflineRank),
            new GameFramework.misc.KeyVal("HintsUsed", aStats[Game.DM.EStat.HINT_USED | 0]),
        ];
    ...
    DoComplement: function Game_Board$DoComplement(theComplementNum) {
        var gComplements = Array.Create(
            7,
            "",
            Game.Resources.SOUND_VOICE_GOOD_ID,
            Game.Resources.SOUND_VOICE_EXCELLENT_ID,
            Game.Resources.SOUND_VOICE_AWESOME_ID,
            Game.Resources.SOUND_VOICE_SPECTACULAR_ID,
            Game.Resources.SOUND_VOICE_EXTRAORDINARY_ID,
            Game.Resources.SOUND_VOICE_UNBELIEVABLE_ID,
            Game.Resources.SOUND_VOICE_BLAZINGSPEED_ID
        );
        Game.SoundUtil.PlayVoice(
            GameFramework.BaseApp.mApp.mResourceManager.GetSoundResourceById(gComplements[theComplementNum])
        );
    ...
    DoAddPoints: function Game_Board$DoAddPoints(
        theX,
        theY,
        thePoints,
        theColor,
        ...
        while (aPointsLeft > 0) {
            ...
            var aPow = 0.8;
            var aCurMovePts =
                (this.GetMoveStat(theMoveCreditId, Game.DM.EStat.POINTS) / this.GetModePointMultiplier()) | 0;
        ...
        return this.mPointsManager.Add(
            theX,
            theY,
            thePoints,
            theColor,
    ...
    AddPoints: function Game_Board$AddPoints(
        theX,
        theY,
        thePoints,
        theColor,
    ...
    RandomizeBoard: function Game_Board$RandomizeBoard(ClearFlags) {
        ...
        do {
            ...
            for (
                var anItr = 0;
                (anItr < 16 || !this.FindMove(null, 0, true, true, false, null, false)) && anItr < 20;
                anItr++
            ) {
                ...
                if (aPiece1.mDestCol == aPiece1.mCol && aPiece1.mDestRow == aPiece1.mRow) {
                    for (var aRotCount = 0; aRotCount < 4; aRotCount++) {
                        for (var aSwapIdx = 0; aSwapIdx < 3; aSwapIdx++) {
                            ...
                            this.mBoard[this.mBoard.mIdxMult0 * aSwapPiece1.mDestRow + aSwapPiece1.mDestCol] =
                                aSwapPiece1;
                            this.mBoard[this.mBoard.mIdxMult0 * aSwapPiece2.mDestRow + aSwapPiece2.mDestCol] =
                                aSwapPiece2;
                        }
        ...
        for (;;) {
            for (var i = 0; i < 3; i++) {
                var aPiece1_2 =
                    this.mBoard[
                        this.mBoard.mIdxMult0 * (this.mRand.NextInt() % this.mRowCount) +
                            (this.mRand.NextInt() % this.mColCount)
                    ];
                var aPiece2 =
                    this.mBoard[
                        this.mBoard.mIdxMult0 * (this.mRand.NextInt() % this.mRowCount) +
                ...
                if (aPiece1_2 != null && aPiece2 != null) {
                    for (var aSwapCount = 0; aSwapCount < 2; aSwapCount++) {
                        ...
                        this.mBoard[this.mBoard.mIdxMult0 * aPiece1_2.mRow + aPiece1_2.mCol] =
                            this.mBoard[this.mBoard.mIdxMult0 * aPiece2.mRow + aPiece2.mCol];
                ...
                if (aPiece != null && aPiece != this.mGameOverPiece) {
                    ...
                    if (aDist < aKillGemRadius) {
                        for (var i = 0; i < 8; i++) {
                            ...
                            anEffect.mY =
                                aPiece.CY() + (GameFramework.Utils.GetRandFloat() * Game.Board.GEM_HEIGHT) / 2;
                            ...
                            var aRatio = 1.0 * 1.67;
                            anEffect.mDX =
                                (aRatio * 4.0 * GameFramework.Utils.GetRandFloat() + Math.cos(anAng) * 16.0) * 1.67;
                            anEffect.mDY =
                                (aRatio * 4.0 * GameFramework.Utils.GetRandFloat() + Math.sin(anAng) * 16.0) * 1.67;
                            ...
                            anEffect.mDAlpha =
                                -0.005 * (4.0 * Math.abs(GameFramework.Utils.GetRandFloat()) + 2.0) * 1.67;
                            this.mPostFXManager.AddEffect(anEffect);
                        }
    ...
    IncPointMult: function Game_Board$IncPointMult(thePieceFrom) {
        ...
        if (!this.mTimeExpired) {
            ...
            var aMultColor = Array.Create(
                7,
                null,
                GameFramework.gfx.Color.RGBToInt(255, 128, 128),
                GameFramework.gfx.Color.RGBToInt(255, 255, 255),
                GameFramework.gfx.Color.RGBToInt(128, 255, 128),
                GameFramework.gfx.Color.RGBToInt(255, 255, 128),
                GameFramework.gfx.Color.RGBToInt(255, 128, 255),
                GameFramework.gfx.Color.RGBToInt(255, 192, 128),
                GameFramework.gfx.Color.RGBToInt(128, 255, 255)
            );
        ...
        if (thePieceFrom != null && thePieceFrom.mColor != Game.DM.EGemColor._INVALID) {
            this.AddPoints(
                ...
                thePieceFrom.CY() | 0,
                1000 * aNextMult,
                Game.DM.gGemColors[thePieceFrom.mColor | 0],
                thePieceFrom.mMatchId,
                false,
                false,
                -1,
                false,
    ...
    Bombify: function Game_Board$Bombify(thePiece, theCounter, realTime) {
        if (
            !thePiece.CanSetFlag(Game.Piece.EFlag.COUNTER) &&
            (realTime
                ? thePiece.CanSetFlag(Game.Piece.EFlag.REALTIME_BOMB)
                : thePiece.CanSetFlag(Game.Piece.EFlag.BOMB))
        ) {
            return;
        }
        thePiece.ClearFlags();
    ...
    GetPieceAtXY: function Game_Board$GetPieceAtXY(theX, theY) {
        {
            ...
            for (var $enum7 = 0; $enum7 < $srcArray7.length; $enum7++) {
                ...
                if (
                    ...
                    theX >= aPiece.mX &&
                    theY >= aPiece.mY &&
                    theX < aPiece.mX + Game.Board.GEM_WIDTH &&
                    theY < aPiece.mY + Game.Board.GEM_WIDTH
                ) {
                    return aPiece;
                }
            }
    ...
    DeletePiece: function Game_Board$DeletePiece(thePiece) {
        ...
        for (var i = 0; i < (this.mSwapDataVector.length | 0); ) {
            ...
            if (aSwapData.mPiece1 == thePiece || aSwapData.mPiece2 == thePiece) {
                if (aSwapData.mSwapPct.get_v() < 0.0 && aSwapData.mPiece1 != null && aSwapData.mPiece2 != null) {
                    ...
                    this.mBoard[this.mBoard.mIdxMult0 * aSwapData.mPiece1.mRow + aSwapData.mPiece1.mCol] =
                        this.mBoard[this.mBoard.mIdxMult0 * aSwapData.mPiece2.mRow + aSwapData.mPiece2.mCol];
        ...
        this.mNextColumnCredit[thePiece.mCol] =
            Math.max(this.mNextColumnCredit[thePiece.mCol], thePiece.mMoveCreditId) | 0;
    ...
    IsPieceSwappingEx: function Game_Board$IsPieceSwappingEx(thePiece, includeIgnored, onlyCheckForwardSwaps) {
        for (var i = 0; i < (this.mSwapDataVector.length | 0); i++) {
            if (
                (!this.mSwapDataVector[i].mIgnore || includeIgnored) &&
                ((this.mSwapDataVector[i].mForwardSwap && this.mSwapDataVector[i].mHoldingSwap == 0) ||
                    !onlyCheckForwardSwaps) &&
                (this.mSwapDataVector[i].mPiece1 == thePiece || this.mSwapDataVector[i].mPiece2 == thePiece)
            ) {
                return true;
            }
        }
    ...
    IsPieceStill: function Game_Board$IsPieceStill(thePiece) {
        return (
            thePiece.mFallVelocity == 0 &&
            !thePiece.mDestPct.IsDoingCurve() &&
            this.GetRowY(thePiece.mRow) == thePiece.mY &&
            !this.IsPieceMatching(thePiece) &&
            !this.IsPieceSwapping(thePiece) &&
            (thePiece.mCanMatch || thePiece.IsFlagSet(Game.Piece.EFlag.DIG)) &&
            thePiece.mExplodeDelay == 0.0 &&
            thePiece.mDestPct.get_v() == 0.0 &&
            !thePiece.IsFlagSet(Game.Piece.EFlag.MYSTERY)
        );
    },
    WillPieceBeStill: function Game_Board$WillPieceBeStill(thePiece) {
        return (
            !this.IsPieceMatching(thePiece) &&
            !this.IsPieceSwappingEx(thePiece, false, true) &&
            thePiece.mCanMatch &&
            thePiece.mExplodeDelay == 0 &&
            thePiece.mDestPct.get_v() == 0 &&
            !thePiece.IsFlagSet(Game.Piece.EFlag.MYSTERY)
        );
    },
    CanBakeShadow: function Game_Board$CanBakeShadow(thePiece) {
        return (
            !this.IsPieceSwapping(thePiece) &&
            thePiece.mRotPct == 0.0 &&
            !thePiece.IsFlagSet(Game.Piece.EFlag.FLAME) &&
            !thePiece.IsFlagSet(Game.Piece.EFlag.LASER) &&
            !thePiece.IsFlagSet(Game.Piece.EFlag.POINT_MULTIPLIER) &&
            !thePiece.IsFlagSet(Game.Piece.EFlag.DETONATOR) &&
            !thePiece.IsFlagSet(Game.Piece.EFlag.SCRAMBLE)
        );
    },
    ...
    DoHypercube: function Game_Board$DoHypercube(thePiece, theSwappedPiece) {
        ...
        aLightningStorm.AddLightning(
            (thePiece.mX | 0) + ((Game.Board.GEM_WIDTH / 2) | 0),
            (thePiece.mY | 0) + ((Game.Board.GEM_HEIGHT / 2) | 0),
            (theSwappedPiece.mX | 0) + ((Game.Board.GEM_WIDTH / 2) | 0),
            (theSwappedPiece.mY | 0) + ((Game.Board.GEM_HEIGHT / 2) | 0)
        );
    },
    ...
    GetTicksLeft: function Game_Board$GetTicksLeft() {
        ...
        var anAmnesty = 250;
        var aTicksLeft =
            Math.min(aTimeLimit * 60, Math.max(0, aTimeLimit * 60 - Math.max(0, this.mGameTicks - anAmnesty))) | 0;
        return aTicksLeft;
    },
    ...
    IsSwapLegal: function Game_Board$IsSwapLegal(theSelected, theSwappedRow, theSwappedCol) {
        ...
        if (aSwappedPiece != null) {
            if (
                !aSwappedPiece.mCanSwap ||
                !this.IsPieceStill(aSwappedPiece) ||
                aSwappedPiece.IsFlagSet(Game.Piece.EFlag.DOOM)
            ) {
                return false;
            }
        }
        ...
        if (
            (theSelected.IsButton() && Math.abs(aDirX) + Math.abs(aDirY) != 0) ||
            (!theSelected.IsButton() && Math.abs(aDirX) + Math.abs(aDirY) != 1)
        ) {
            return false;
        }
        return true;
    },
    QueueSwap: function Game_Board$QueueSwap(
        theSelected,
        theSwappedRow,
        theSwappedCol,
        forceSwap,
    ...
    TrySwapEx: function Game_Board$TrySwapEx(
        theSelected,
        theSwappedRow,
        theSwappedCol,
        forceSwap,
        ...
        if (
            theSwappedRow < 0 ||
            theSwappedRow >= this.mRowCount ||
            theSwappedCol < 0 ||
            theSwappedCol >= this.mColCount
        ) {
            return false;
        }
        if (!this.IsSwapLegal(theSelected, theSwappedRow, theSwappedCol)) {
        ...
        aSwapData.mSwapDir = new GameFramework.geom.TIntPoint(
            theSwappedCol - theSelected.mCol,
            theSwappedRow - theSelected.mRow
        );
    ...
    SwapPieceLocations: function Game_Board$SwapPieceLocations(thePieceA, thePieceB, theIncludeXY) {
        ...
        this.mBoard[this.mBoard.mIdxMult0 * thePieceA.mRow + thePieceA.mCol] =
            this.mBoard[this.mBoard.mIdxMult0 * thePieceB.mRow + thePieceB.mCol];
    ...
    TrySwapAndRecordForce: function Game_Board$TrySwapAndRecordForce(
        theSelected,
        theSwappedRow,
        theSwappedCol,
        forceSwap,
    ...
    TrySwapAndRecordEx: function Game_Board$TrySwapAndRecordEx(
        theSelected,
        theSwappedRow,
        theSwappedCol,
        forceSwap,
                                ...
                                if (aSubPiece.mElectrocutePercent >= 1.0) {
                                    ...
                                    if (!aSubPiece.mDestructing) {
                                        ...
                                        if (aSubPiece.IsFlagSet(Game.Piece.EFlag.POINT_MULTIPLIER)) {
                                            ...
                                            !this.TriggerSpecialEx(aSubPiece, aSrcPiece) &&
                                            !aSubPiece.mDestructing
                                        ) {
                    ...
                    if (anInfo.mTimer <= 0) {
                        ...
                        for (var anOffset = anOffsetStart; anOffset < anOffsetEnd; anOffset++) {
                            for (var aSubOffset = -aSpread; aSubOffset <= aSpread; aSubOffset++) {
                                var aDist_2 =
                                    anInfo.mStormType == Game.LightningStorm.EStormType.SCREEN ? 1 : anInfo.mDist;
                                var aSubX =
                                    anInfo.mCX +
                                    (aDist_2 * offsets[offsets.mIdxMult0 * anOffset + 0] +
                                        offsets[offsets.mIdxMult0 * anOffset + 1] * aSubOffset) *
                                        Game.Board.GEM_WIDTH;
                                var aSubY =
                                    anInfo.mCY +
                                    (aDist_2 * offsets[offsets.mIdxMult0 * anOffset + 1] +
                                        offsets[offsets.mIdxMult0 * anOffset + 0] * aSubOffset) *
                                        Game.Board.GEM_HEIGHT;
                                ...
                                if (aSubPiece_2 != null && !aSubPiece_2.mDestructing) {
                                    ...
                                    if (aSubPiece_2.mElectrocutePercent == 0) {
                                        ...
                                        if (!GameFramework.BaseApp.mApp.get_Is3D() || Game.BejApp.mBejApp.mIsSlow) {
                                            for (var i_4 = 0; i_4 < 5; i_4++) {
                                                var anEffect = this.mPostFXManager.AllocEffect(
                                                    Game.Effect.EFxType.SPARKLE_SHARD
                                                );
                                                anEffect.mX =
                                                    aSubX +
                                                    this.GetBoardX() +
                                                    (GameFramework.Utils.GetRandFloat() *
                                                        Math.abs(offsets[offsets.mIdxMult0 * anOffset + 0]) *
                                                        Game.Board.GEM_WIDTH) /
                                                        3;
                                                anEffect.mY =
                                                    aSubY +
                                                    this.GetBoardY() +
                                                    (GameFramework.Utils.GetRandFloat() *
                                                        Math.abs(offsets[offsets.mIdxMult0 * anOffset + 1]) *
                                                        Game.Board.GEM_HEIGHT) /
                                                        3;
                                                anEffect.mDX =
                                                    ((GameFramework.Utils.GetRandFloat() *
                                                        (Math.abs(offsets[offsets.mIdxMult0 * anOffset + 1]) + 0.5) *
                                                        10) |
                                                        0) *
                                                    1.67;
                                                anEffect.mDY =
                                                    ((GameFramework.Utils.GetRandFloat() *
                                                        (Math.abs(offsets[offsets.mIdxMult0 * anOffset + 0]) + 0.5) *
                                                        10) |
                                                        0) *
                                                    1.67;
                                                this.mPostFXManager.AddEffect(anEffect);
                                            ...
                                            for (var i_5 = 0; i_5 < 20; i_5++) {
                                                var anEffect_2 = this.mPostFXManager.AllocEffect(
                                                    Game.Effect.EFxType.SPARKLE_SHARD
                                                );
                                                anEffect_2.mX =
                                                    aSubX +
                                    ...
                                    aSubPiece_2.mShakeScale = Math.min(
                                        1.0,
                                        Math.max(aSubPiece_2.mShakeScale, aSubPiece_2.mElectrocutePercent)
                                    );
                                }
                            }
                        }
    ...
    ExplodeAtHelper: function Game_Board$ExplodeAtHelper(theX, theY) {
        ...
        var aLgCheckPositions = Array.Create2D(
            13,
            2,
            0,
            -1,
        ...
        for (var anOffsets = 0; anOffsets < ((aCheckPositions.length / 2) | 0); anOffsets++) {
            ...
            if (aPiece != null && (aPiece.mExplodeDelay == 0 || anOffsets == 8)) {
                ...
                if (
                    aCheckPositions[aCheckPositions.mIdxMult0 * anOffsets + 0] != 0 ||
                    aCheckPositions[aCheckPositions.mIdxMult0 * anOffsets + 1] != 0
                ) {
                    if (GameFramework.BaseApp.mApp.get_Is3D() && !Game.BejApp.mBejApp.mIsSlow) {
                        if (this.WantsCalmEffects()) {
                            for (var i = 0; i < 14; i++) {
                                ...
                                anEffect_2.mX =
                                    aRatio * aXCenter +
                                    (1.0 - aRatio) * aPieceCenterX +
                                    Math.cos(anAngle) * 64.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                                anEffect_2.mY =
                                    aRatio * aYCenter +
                                    (1.0 - aRatio) * aPieceCenterY +
                                    Math.sin(anAngle) * 64.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                            ...
                            for (var i_2 = 0; i_2 < 14; i_2++) {
                                ...
                                anEffect_3.mX =
                                    aRatio_2 * aXCenter +
                                    (1.0 - aRatio_2) * aPieceCenterX +
                                    Math.cos(anAngle_2) * 64.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                                anEffect_3.mY =
                                    aRatio_2 * aYCenter +
                                    (1.0 - aRatio_2) * aPieceCenterY +
                                    Math.sin(anAngle_2) * 64.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                        ...
                        for (var i_3 = 0; i_3 < 25; i_3++) {
                            ...
                            if (aDistVX != 0 || aDistVY != 0) {
                                ...
                                aRot =
                                    Math.atan2(anEffect_4.mY - aYCenter, anEffect_4.mX - aXCenter) +
                                    GameFramework.Utils.GetRandFloat() * 0.3;
                            ...
                            anEffect_4.mDAlpha =
                                -0.0025 * (2.0 * Math.abs(GameFramework.Utils.GetRandFloat()) + 4.0) * 1.67;
                        ...
                        for (var i_4 = 0; i_4 < 14; i_4++) {
                            ...
                            anEffect_5.mX =
                                aPieceCenterX +
                                Math.cos(anAngle_3) * 25.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                            anEffect_5.mY =
                                aPieceCenterY +
                                Math.sin(anAngle_3) * 25.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                        ...
                        for (var i_5 = 0; i_5 < 6; i_5++) {
                            ...
                            anEffect_6.mX =
                                aPieceCenterX +
                                Math.cos(anAngle_4) * 20.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                            anEffect_6.mY =
                                aPieceCenterY +
                                Math.sin(anAngle_4) * 20.0 * Math.abs(GameFramework.Utils.GetRandFloat());
                    ...
                    if (doChainReaction) {
                        ...
                        if (aPiece.IsFlagSet(Game.Piece.EFlag.LASER)) {
                            ...
                            if (aStormIdx != -1) {
                                ...
                                if (
                                    aLightingStorm.mUpdateCnt == 0 &&
                                    (aLightingStorm.mStormType == Game.LightningStorm.EStormType.HORZ ||
                                        aLightingStorm.mStormType == Game.LightningStorm.EStormType.VERT)
                                ) {
                                    this.mLightningStorms.removeAt(aStormIdx);
                        ...
                        if (
                            ((aPiece.IsFlagSet(Game.Piece.EFlag.FLAME) ||
                                aPiece.IsFlagSet(Game.Piece.EFlag.BLAST_GEM)) &&
                                !aPiece.IsFlagSet(Game.Piece.EFlag.LASER)) ||
                            !this.TriggerSpecialEx(aPiece, aCenterPiece)
                        ) {
                            if (aPiece.mCanDestroy) {
                                ...
                                this.AddPoints(
                                    ...
                                    aPiece.GetScreenY() | 0,
                                    20,
                                    Game.DM.gGemColors[(aPiece.mColor | 0) + 1],
                                    aPiece.mMatchId,
                                    true,
                                    true,
    ...
    SmallExplodeAt: function Game_Board$SmallExplodeAt(thePiece, theCenterX, theCenterY, process, fromFlame) {
        if (!thePiece.IsFlagSet(Game.Piece.EFlag.SCRAMBLE) && !thePiece.IsFlagSet(Game.Piece.EFlag.DETONATOR)) {
            this.AddPoints(
                thePiece.GetScreenX() | 0,
                thePiece.GetScreenY() | 0,
                50,
                Game.DM.gGemColors[(thePiece.mColor | 0) + 1],
                thePiece.mMatchId,
                true,
                true,
        ...
        for (var i_2 = 0; i_2 < 25; i_2++) {
            ...
            if (aDistVX != 0 || aDistVY != 0) {
                ...
                aRot =
                    Math.atan2(anEffect_2.mY - theCenterY, anEffect_2.mX - theCenterX) +
                    GameFramework.Utils.GetRandFloat() * 0.3;
            ...
            if (thePiece.mElectrocutePercent > 0) {
                ...
                for (var j = 0; j < aCount; j++) {
                    ...
                    anEffect_4.mX =
                        ...
                        (Math.cos(anAngle_3) * Game.Board.GEM_WIDTH) / 2;
                    anEffect_4.mY =
                        thePiece.GetScreenY() +
                        ((Game.Board.GEM_HEIGHT / 2) | 0) +
                        (Math.sin(anAngle_3) * Game.Board.GEM_HEIGHT) / 2;
            ...
            for (var aCheckCol = 0; aCheckCol < this.mColCount; aCheckCol++) {
                ...
                for (var aSwapIdx = 0; aSwapIdx < 4; aSwapIdx++) {
                    ...
                    if (aSwapCol >= 0 && aSwapCol < 8 && aSwapRow >= 0 && aSwapRow < 8) {
                        ...
                        if (
                            aPiece != null &&
                            aPiece.IsFlagSet(Game.Piece.EFlag.HYPERCUBE) &&
                            this.mBoard[this.mBoard.mIdxMult0 * aSwapRow + aSwapCol] != null
                        ) {
                        ...
                        if (
                            this.mBoard[this.mBoard.mIdxMult0 * aSwapRow + aSwapCol] != null &&
                            this.mBoard[this.mBoard.mIdxMult0 * aSwapRow + aSwapCol].mColor !=
                                Game.DM.EGemColor._INVALID &&
                            this.mBoard[this.mBoard.mIdxMult0 * aSwapRow + aSwapCol].mWillPieceBeStill
                        ) {
                            this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aCheckCol] =
                                this.mBoard[this.mBoard.mIdxMult0 * aSwapRow + aSwapCol];
                            ...
                            while (
                                aLeftCol > 0 &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aLeftCol - 1] != null &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aCheckCol].mColor ==
                                    this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aLeftCol - 1].mColor &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aLeftCol - 1].mWillPieceBeStill
                            ) {
                            ...
                            while (
                                aRightCol < 7 &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aRightCol + 1] != null &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aCheckCol].mColor ==
                                    this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aRightCol + 1].mColor &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aRightCol + 1].mWillPieceBeStill
                            ) {
                            ...
                            while (
                                aTopRow > 0 &&
                                this.mBoard[this.mBoard.mIdxMult0 * (aTopRow - 1) + aCheckCol] != null &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aCheckCol].mColor ==
                                    this.mBoard[this.mBoard.mIdxMult0 * (aTopRow - 1) + aCheckCol].mColor &&
                                this.mBoard[this.mBoard.mIdxMult0 * (aTopRow - 1) + aCheckCol].mWillPieceBeStill
                            ) {
                            ...
                            while (
                                aBottomRow < 7 &&
                                this.mBoard[this.mBoard.mIdxMult0 * (aBottomRow + 1) + aCheckCol] != null &&
                                this.mBoard[this.mBoard.mIdxMult0 * aCheckRow + aCheckCol].mColor ==
                                    this.mBoard[this.mBoard.mIdxMult0 * (aBottomRow + 1) + aCheckCol].mColor &&
                                this.mBoard[this.mBoard.mIdxMult0 * (aBottomRow + 1) + aCheckCol].mWillPieceBeStill
                            ) {
                                if (
                                    theIncludePiece == this.mBoard[this.mBoard.mIdxMult0 * (aBottomRow + 1) + aCheckCol]
                                ) {
                                    includedPiece = true;
                                }
                                aBottomRow++;
    ...
    HasIllegalSet: function Game_Board$HasIllegalSet() {
        ...
        for (aRow = 0; aRow < 8; aRow++) {
            ...
            for (aCol = 0; aCol < 8; aCol++) {
                ...
                if (aPiece != null) {
                    var isGemProtected =
                        aPiece.mCreatedTick == this.mUpdateCnt && aPiece.IsFlagSet(Game.Piece.EFlag.POINT_MULTIPLIER);
                    if (aPiece.mColor != Game.DM.EGemColor._INVALID && aPiece.mColor == aLastColor) {
                        if (isGemProtected) {
        ...
        for (aCol = 0; aCol < 8; aCol++) {
            ...
            for (aRow = 0; aRow < 8; aRow++) {
                var aPiece_2 = this.mBoard[this.mBoard.mIdxMult0 * aRow + aCol];
                if (aPiece_2 != null) {
                    var isGemProtected_2 =
                        aPiece_2.mCreatedTick == this.mUpdateCnt &&
    ...
    FindSetsEx: function Game_Board$FindSetsEx(fromUpdateSwapping, thePiece1, thePiece2) {
        ...
        for (var i_2 = 0; i_2 < 2; i_2++) {
            for (var i1 = 0; i1 < 8; i1++) {
                ...
                for (var i2 = 0; i2 < 8; i2++) {
                    ...
                    var aPiece = this.mBoard[this.mBoard.mIdxMult0 * aRow + aCol];
                    var isPieceStill =
                        ((aPiece != null && aPiece.mIsPieceStill) || aTallyPieceSet.indexOf(aPiece) != -1) &&
                        aDelayingPieceSet.indexOf(aPiece) == -1;
                    var matchablePiece =
                        aPiece != null && (aPiece.mWillPieceBeStill || aTallyPieceSet.indexOf(aPiece) != -1);
                    if (matchablePiece) {
                        ...
                        if (aMatchCount >= 3) {
                                    ...
                                    if (aMarkPiece != null) {
                                        ...
                                        for (var anOffsetIdx = 0; anOffsetIdx < 4; anOffsetIdx++) {
                                            for (var aDist = 1; aDist < 8; aDist++) {
                                                var anAdjacentPiece = this.GetPieceAtRowCol(
                                                    aMarkPiece.mRow +
                                                        anOffsets[anOffsets.mIdxMult0 * anOffsetIdx + 0] * aDist,
                                                    aMarkPiece.mCol +
                                                        anOffsets[anOffsets.mIdxMult0 * anOffsetIdx + 1] * aDist
                                                );
                                                if (
                                                    anAdjacentPiece != null &&
                                                    anAdjacentPiece.mColor == aMarkPiece.mColor
                                                ) {
                                                    var isUnsettled =
                                                        !anAdjacentPiece.mIsPieceStill &&
                                                        anAdjacentPiece.mWillPieceBeStill;
                                        ...
                                        aLastMoveCreditId =
                                            Math.max(aLastMoveCreditId, aMarkPiece.mLastMoveCreditId) | 0;
                                    }
                                }
                            }
                            if (aMoveCreditId == -1) {
                            ...
                            if (isFutureMatch || needsSettling) {
                                ...
                                for (var aMarkRow_4 = aFirstMatchRow; aMarkRow_4 <= aLastMatchRow; aMarkRow_4++) {
                                    for (var aMarkCol_4 = aFirstMatchCol; aMarkCol_4 <= aLastMatchCol; aMarkCol_4++) {
                                        ...
                                        if (aMarkPiece_4 != null) {
                                            ...
                                            if (
                                                aMarkPiece_4.IsFlagSet(Game.Piece.EFlag.FLAME) ||
                                                aMarkPiece_4.IsFlagSet(Game.Piece.EFlag.BLAST_GEM)
                                            ) {
                                                aDeferExplodeVector.push(aMarkPiece_4);
                                                aMatchSet.mExplosionCount++;
                                            }
                                            if (
                                                aMarkPiece_4.IsFlagSet(Game.Piece.EFlag.LASER) &&
                                                ...
                                                if (aStormIdx == -1) {
                                                    ...
                                                    var aStorm = new Game.LightningStorm(
                                                        this,
                                                        aMarkPiece_4,
                                                        this.mFullLaser
                                                            ? Game.LightningStorm.EStormType.BOTH
                                                            : Game.LightningStorm.EStormType.SHORT
                                                    );
                                                    this.mLightningStorms.push(aStorm);
                                                }
                                            } else if (
                                                aMarkPiece_4.mChangedTick == this.mUpdateCnt &&
                                                aMarkPiece_4.mColor != Game.DM.EGemColor._INVALID
                                            ) {
                                                if (
                                                    aMarkPiece_4.mFlags == 0 ||
                                                    aMarkPiece_4.IsFlagSet(Game.Piece.EFlag.FLAME)
                                                ) {
                                                    if (this.AllowPowerups()) {
                                                        if (this.WantsTutorial(Game.DM.ETutorial.LASER)) {
                                                            this.DeferTutorialDialog(
                                                                Game.DM.ETutorial.LASER,
                                                                aMarkPiece_4
                                                            );
                                                            isSetBulging = true;
                                                ...
                                                if (justSwapped) {
                                                    aMarkPiece_4.mScale.SetCurve(
                                                        "b+1,1.2,0.333333,1,#+Ky         ~~###"
                                                    );
                                                } else if (this.WantBulgeCascades()) {
                                                    aMarkPiece_4.mScale.SetCurve(
                                                        "b+1,1.22,0.033333,1,#+Kx      uw*7u   ,~###"
                                                    );
                                                } else {
                                                    aMarkPiece_4.mScale.SetCurve(
                                                        "b+1,1.22,0.066667,1,#+Kx      uw*7t   ,~###"
                                                    );
                                                }
                                ...
                                if (aPowerupCandidates.length > 0) {
                                    var aPowerupPiece =
                                        aNewestPowerupCandidates[(aNewestPowerupCandidates.length / 2) | 0 | 0];
                                    for (var anIdx = 0; anIdx < (aPowerupCandidates.length | 0); anIdx++) {
                                        ...
                                        if (
                                            aSide1 != null &&
                                            aSide1.mColor == aTestPiece.mColor &&
                                            aSide2 != null &&
                                            aSide2.mColor == aTestPiece.mColor
                                        ) {
                                    ...
                                    var aStartDist =
                                        Math.max(
                                            Math.abs(aFirstMatchCol - aPowerupPiece.mCol),
                                            Math.abs(aFirstMatchRow - aPowerupPiece.mRow)
                                        ) | 0;
                                    var anEndDist =
                                        Math.max(
                                            Math.abs(aLastMatchCol - aPowerupPiece.mCol),
                                            Math.abs(aLastMatchRow - aPowerupPiece.mRow)
                                        ) | 0;
                                    var aPowerupPieceBackup = null;
                                    for (var aDist_2 = 1; aDist_2 <= 2; aDist_2++) {
                                        if (aStartDist > anEndDist) {
                                            if (i_2 == 0) {
                                                aPowerupPieceBackup = this.GetPieceAtRowCol(
                                                    Math.max(aFirstMatchRow, aPowerupPiece.mRow - aDist_2) | 0,
                                                    aPowerupPiece.mCol
                                                );
                                            } else {
                                                aPowerupPieceBackup = this.GetPieceAtRowCol(
                                                    aPowerupPiece.mRow,
                                                    Math.max(aFirstMatchCol, aPowerupPiece.mCol - aDist_2) | 0
                                                );
                                            }
                                        } else {
                                            if (i_2 == 0) {
                                                aPowerupPieceBackup = this.GetPieceAtRowCol(
                                                    Math.min(aLastMatchRow, aPowerupPiece.mRow + aDist_2) | 0,
                                                    aPowerupPiece.mCol
                                                );
                                            } else {
                                                aPowerupPieceBackup = this.GetPieceAtRowCol(
                                                    aPowerupPiece.mRow,
                                                    Math.min(aLastMatchCol, aPowerupPiece.mCol + aDist_2) | 0
                                                );
                                            }
                                        }
                                    ...
                                    if (this.AllowPowerups()) {
                                        if (
                                            aMatchCount >= 6 &&
                                            aPowerupPiece.CanSetFlag(Game.Piece.EFlag.LASER) &&
                                            aPowerupPiece.CanSetFlag(Game.Piece.EFlag.FLAME)
                                        ) {
                                            ...
                                            aMatchCount >= 5 &&
                                            !aPowerupPiece.IsFlagSet(Game.Piece.EFlag.LASER) &&
                                            aBulgeTriggerPieceSet.indexOf(aPowerupPiece) == -1
                                        ) {
                                ...
                                if (isSetBulging) {
                                    for (var aMarkRow_5 = aFirstMatchRow; aMarkRow_5 <= aLastMatchRow; aMarkRow_5++) {
                                        for (
                                            var aMarkCol_5 = aFirstMatchCol;
                                            aMarkCol_5 <= aLastMatchCol;
                                            aMarkCol_5++
                                        ) {
                                            var aMarkPiece_5 =
                                                this.mBoard[this.mBoard.mIdxMult0 * aMarkRow_5 + aMarkCol_5];
        ...
        for (var i_4 = 0; i_4 < aDeferPowerupMapPiece.length; ++i_4) {
            ...
            if (aPowerupPiece_2.mFlags == 0 && aBulgeTriggerPieceSet.indexOf(aPowerupPiece_2) == -1) {
                ...
                if (
                    aPowerupPiece_2.mColor != Game.DM.EGemColor._INVALID &&
                    aPowerupPiece_2.mColor != Game.DM.EGemColor.HYPERCUBE
                ) {
        ...
        for (var aSetIdx = 0; aSetIdx < (aMatchedSets.length | 0); aSetIdx++) {
            ...
            if (isBulging) {
                ...
                this.AddPoints(
                    anAvgX + ((Game.Board.GEM_WIDTH / 2) | 0),
                    anAvgY + ((Game.Board.GEM_HEIGHT / 2) | 0) - 8,
                    aNumPoints,
                    Game.DM.gPointColors[(aMatchSet_2.mPieces[0].mColor | 0) + 1],
                    aMatchSet_2.mMatchId,
                    true,
                    true,
                    aMatchSet_2.mMoveCreditId,
                    false,
                    Game.Board.EPointType.MATCH
                );
            ...
            if (fromUpdateSwapping && this.mSpeedBonusCount > 0) {
                if (this.mSpeedBonusNum > 0.01) {
                    ...
                    Game.SoundUtil.PlayEx(
                        GameFramework.BaseApp.mApp.mResourceManager.GetSoundResourceById(
                            "SOUND_SPEEDMATCH" + (Math.min(8 + 1, this.mSpeedBonusCount + 1) | 0)
                        ),
                        aPan,
                        1.0
                    );
    ...
    MenuButtonPressed: function Game_Board$MenuButtonPressed(e) {
        ...
        aMenu.mY = 200;
        aMenu.AddEventListener(
            GameFramework.widgets.DialogEvent.CLOSED,
            ss.Delegate.create(this, this.handleGameMenuClosed)
        );
    },
    ...
    ResetButtonPressed: function Game_Board$ResetButtonPressed(e) {
        ...
        if (this.mGameOverCount == 0) {
            var aDialog = Game.BejApp.mBejApp.DoModalDialog(
                ...
                Game.DM.EDialog.RESET
            );
            var aWidth = 850;
            aDialog.Resize(
                this.GetBoardCenterX() - ((aWidth / 2) | 0),
                350,
                aWidth,
            ...
            aDialog.AddEventListener(
                GameFramework.widgets.DialogEvent.CLOSED,
                ss.Delegate.create(this, this.handleResetDialogClosed)
            );
        }
    },
    ...
    FillInBlanksEx: function Game_Board$FillInBlanksEx(allowCascades) {
            ...
            for (var aCol_2 = 0; aCol_2 < 8; aCol_2++) {
                ...
                for (var aRow_2 = this.mBottomFillRow; aRow_2 >= 0; aRow_2--) {
                    ...
                    if (aPiece_2 != null) {
                        ...
                        if (
                            colFalling &&
                            (this.IsPieceSwapping(aPiece_2) ||
                                aPiece_2.mDestPct.IsDoingCurve() ||
                                aPiece_2.mDestRow == -1 ||
                                this.IsPieceMatching(aPiece_2))
                        ) {
                            aFallCount = 0;
        ...
        if (aNewPieceVector.length > 0) {
            ...
            for (;;) {
                ...
                if (this.WantHyperMixers()) {
                    ...
                    if (doHyperCube) {
                        ...
                        var dropHyper = false;
                        if (
                            this.WantHypermixerBottomCheck() &&
                            this.FindMove(aCoords, 0, true, true, true, null, false)
                        ) {
                        ...
                        if (!dropHyper && this.WantHypermixerEdgeCheck()) {
                            ...
                            while (
                                (!foundL || !foundR) &&
                                this.FindMove(aCoords, pieceId++, true, true, false, null, false)
                            ) {
                        ...
                        if (dropHyper) {
                            for (;;) {
                                var aPiece_5 =
                                    aNewPieceVector[(GameFramework.Utils.GetRandFloatU() * aNewPieceVector.length) | 0];
                ...
                for (var aGemNum_2 = 0; aGemNum_2 < (aNewPieceVector.length | 0); aGemNum_2++) {
                    ...
                    if (
                        aPiece_6.mFlags == 0 ||
                        aPiece_6.IsFlagSet(Game.Piece.EFlag.BOMB) ||
                        aPiece_6.IsFlagSet(Game.Piece.EFlag.REALTIME_BOMB)
                    ) {
            ...
            if (
                aNewPieceVector.length == this.mColCount * this.mRowCount &&
                this.mGameTicks > 0 &&
                this.WantAnnihilatorReplacement()
            ) {
    ...
    MatchMade: function Game_Board$MatchMade(theSwapData) {
        ...
        if (
            this.mSpeedBonusCount >= 9 &&
            this.mSpeedBonusFlameModePct == 0 &&
            (this.GetTimeLimit() == 0 || this.GetTicksLeft() >= 5)
        ) {
            var aPctHit = 1.5;
            if (aNewTime >= Game.DM.SPEED_TIME_RIGHT) {
                aPctHit = Math.max(
                    ...
                    Math.min(
                        1.5,
                        1.0 -
                            (aNewTime - Game.DM.SPEED_TIME_RIGHT) / (Game.DM.SPEED_TIME_RIGHT - Game.DM.SPEED_TIME_LEFT)
                    )
                );
            }
            var aDelta = aPctHit - this.mSpeedBonusNum;
            if (aDelta > 0) {
                this.mSpeedBonusNum = Math.min(
                    1.0,
                    this.mSpeedBonusNum + Math.min(0.1, aDelta * this.GetSpeedBonusRamp())
                );
...

            {
                ...
                for (var $enum15 = 0; $enum15 < $srcArray15.length; $enum15++) {
                    ...
                    if (aPoints.mUpdateCnt == 0) {
                        ...
                        this.mSpeedBonusPoints +=
                            (aNumPoints * this.mPointMultiplier * this.GetModePointMultiplier()) | 0;
                        this.AddPoints(
                            aPoints.mX | 0,
                            aPoints.mY | 0,
                            aNumPoints,
                            ...
                            false,
                            true,
                            aPoints.mMoveCreditId,
                            false,
                            Game.Board.EPointType.SPEED
                        );
                        aPoints.mUpdateCnt++;
                        break;
                    }
    ...
    UpdateSpeedBonus: function Game_Board$UpdateSpeedBonus() {
        ...
        var aSpeedTally =
            Math.min(this.mMatchTallyCount - Game.DM.SPEED_START_THRESHOLD + 1, Game.DM.SPEED_MAX_THRESHOLD) | 0;
        var aGoalTime =
            Game.DM.SPEED_TIME_LEFT + this.mSpeedBonusNum * (Game.DM.SPEED_TIME_RIGHT - Game.DM.SPEED_TIME_LEFT);
    ...
    CalcAwesomeness: function Game_Board$CalcAwesomeness(theMoveCreditId) {
        var anAwesomeness =
            Math.max(0, Math.pow(Math.max(0, this.GetMoveStat(theMoveCreditId, Game.DM.EStat.CASCADES) - 1), 1.5)) | 0;
    ...
    DecrementAllCounterGems: function Game_Board$DecrementAllCounterGems(immediate) {
        {
            ...
            for (var $enum16 = 0; $enum16 < $srcArray16.length; $enum16++) {
                ...
                if (
                    aPiece != null &&
                    !aPiece.IsFlagSet(Game.Piece.EFlag.REALTIME_BOMB) &&
                    !aPiece.IsFlagSet(Game.Piece.EFlag.DOOM)
                ) {
    ...
    SetTutorialCleared: function Game_Board$SetTutorialCleared(theTutorial, isCleared, sendTutorialCleared) {
        ...
        if (
            (this.mTutorialMgr.GetTutorialFlags() & (1 << (theTutorial | 0))) == 0 &&
            isCleared &&
            sendTutorialCleared
        ) {
            var aTutorialName = Game.DM.gTutorialNames[theTutorial | 0];
            if (aTutorialName != null) {
                Game.BejApp.mBejApp.SubmitStandardMetrics("tutorial_cleared", [
                    new GameFramework.misc.KeyVal("GameId", this.mGameId),
                    new GameFramework.misc.KeyVal("TutorialType", aTutorialName),
                    new GameFramework.misc.KeyVal("TutorialsEnabled", Game.BejApp.mBejApp.mProfile.mTutorialEnabled),
                ]);
            }
        }
    ...
    CheckForTutorialDialogs: function Game_Board$CheckForTutorialDialogs() {
        if (
            Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.TUTORIAL) != null ||
            Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.HELP) != null
        ) {
            return;
        }
        ...
        while (this.mDeferredTutorialVector.length > 0) {
            ...
            switch (aDeferredTutorial.mTutorialFlag) {
                case Game.DM.ETutorial.FLAME: {
                    aHeader = "FLAME GEM";
                    aText =
                        "You made a ^007700^FLAME GEM^000000^ by matching 4 Gems in a row. Match it for an explosion!";
                    break;
                }
                ...
                case Game.DM.ETutorial.SUPERNOVA: {
                    ...
                    aText =
                        "You made a ^007700^SUPERNOVA GEM^000000^ by matching 6+ Gems in a row. This powerful Gem explodes with the force of a million suns when matched.";
                    break;
                }
                case Game.DM.ETutorial.MULTIPLIER: {
                    aHeader = "MULTIPLIER GEM";
                    aText =
                        "You have received a ^007700^MULTIPLIER GEM^000000^! Match it to multiply your score for the rest of the game.";
                    break;
                }
                case Game.DM.ETutorial.TIME_BONUS: {
                    aHeader = "TIME GEM";
                    aText =
                        "You have received a ^007700^TIME GEM^000000^! Collect them to extend your game after the timer bar empties!";
                    break;
                }
            }
            ...
            aDialog.AddEventListener(
                GameFramework.widgets.DialogEvent.CLOSED,
                ss.Delegate.create(this, this.HandleHintDialogClosed)
            );
            ...
            if (aPiece != null) {
                if (aPiece.mRow < 4) {
                    aDialog.Move(
                        this.GetBoardCenterX() - aDialog.mWidth / 2,
                        aPiece.GetScreenY() + Game.Board.GEM_HEIGHT + 15
                    );
                } else {
                    aDialog.Move(
                        this.GetBoardCenterX() - aDialog.mWidth / 2,
                        aPiece.GetScreenY() - 15 - aDialog.mHeight
                    );
                }
            }
    ...
    UpdateSwapping: function Game_Board$UpdateSwapping() {
        for (var aSwapDataIdx = 0; aSwapDataIdx < (this.mSwapDataVector.length | 0); aSwapDataIdx++) {
            ...
            var aSwapCenterX =
                this.GetColX(aSwapData.mPiece1.mCol) + (((aSwapData.mSwapDir.x * Game.Board.GEM_WIDTH) / 2) | 0);
            var aSwapCenterY =
                this.GetRowY(aSwapData.mPiece1.mRow) + (((aSwapData.mSwapDir.y * Game.Board.GEM_WIDTH) / 2) | 0);
            aSwapData.mPiece1.mX =
                aSwapCenterX - (aSwapData.mSwapPct.get_v() * aSwapData.mSwapDir.x * Game.Board.GEM_WIDTH) / 2;
            aSwapData.mPiece1.mY =
                aSwapCenterY - (aSwapData.mSwapPct.get_v() * aSwapData.mSwapDir.y * Game.Board.GEM_WIDTH) / 2;
            if (!aSwapData.mDestroyTarget && aSwapData.mPiece2 != null) {
                aSwapData.mPiece2.mX =
                    aSwapCenterX + (aSwapData.mSwapPct.get_v() * aSwapData.mSwapDir.x * Game.Board.GEM_WIDTH) / 2;
                aSwapData.mPiece2.mY =
                    aSwapCenterY + (aSwapData.mSwapPct.get_v() * aSwapData.mSwapDir.y * Game.Board.GEM_WIDTH) / 2;
            }
            if (done) {
                ...
                if (aSwapData.mForwardSwap) {
                    ...
                    for (var aSwapPass = 0; aSwapPass < 2; aSwapPass++) {
                        ...
                        if (aSwapPass == 1 || foundSets != 0 || forceSwap) {
                            if (
                                (foundSets == 2 && !forceSwap) ||
                                (aSwapData.mPiece1 != null && aSwapData.mPiece1.mIsBulging) ||
                                (aSwapData.mPiece2 != null && aSwapData.mPiece2.mIsBulging)
                            ) {
                            ...
                            if (
                                aSwapPass == 0 &&
                                this.mLastComboCount == this.mComboCount &&
                                aSwapData.mPiece1.mColor == this.mLastPlayerSwapColor
                            ) {
                                this.ComboFailed();
                            }
                            if (aSwapPass == 0) {
    ...
    UpdateFalling: function Game_Board$UpdateFalling() {
        ...
        var aFallVel = this.GetGravityFactor() * 0.4675;
        {
            for (var aCol = 0; aCol < this.mColCount; aCol++) {
                ...
                for (var aRow = this.mRowCount - 1; aRow >= 0; aRow--) {
                    ...
                    if (
                        aPiece_2 != null &&
                        (aPiece_2.mIsPieceStill ||
                            (!this.IsPieceSwapping(aPiece_2) && !this.IsPieceMatching(aPiece_2)) ||
        ...
        if (aHitCount > 0 && Math.abs(this.mLastHitSoundTick - this.mUpdateCnt) >= 5) {
            ...
            Game.SoundUtil.PlayEx(
                Game.Resources["SOUND_GEM_HIT"],
                this.GetPanPosition((aCumHitX / aHitCount) | 0),
                1.0
            );
        }
    },
    UpdateHint: function Game_Board$UpdateHint() {
        if (
            this.mIsBoardStill &&
            this.mBoardHidePct == 0 &&
            this.CanPlay() &&
            Game.BejApp.mBejApp.mDialogMgr.GetDialog(Game.DM.EDialog.TUTORIAL) == null &&
            (!this.mTutorialMgr.IsBusy() || this.mTutorialMgr.AllowHints())
        ) {
            this.mLastMoveTicks++;
            this.mWantHintTicks++;
    ...
    UpdateLevelBar: function Game_Board$UpdateLevelBar() {
        ...
        if (this.mLevelBarPct < aLevelPct) {
            if (this.mTimerAlpha.get_v() == 0) {
                this.mLevelBarPct = Math.min(
                    aLevelPct,
                    this.mLevelBarPct + (aLevelPct - this.mLevelBarPct) * 0.0255 + 0.0012
                );
            } else {
                this.mLevelBarPct = Math.min(
                    aLevelPct,
                    this.mLevelBarPct + (aLevelPct - this.mLevelBarPct) * 0.025 + 0.0005
                );
            }
        } else {
            this.mLevelBarPct = Math.max(
                aLevelPct,
                this.mLevelBarPct + (aLevelPct - this.mLevelBarPct) * 0.05 - 0.0001
            );
        }
    ...
    UpdateCountdownBar: function Game_Board$UpdateCountdownBar() {
        ...
        if (this.mCountdownBarPct < aCountdownPct) {
            if (this.mTimerAlpha.get_v() == 0) {
                this.mCountdownBarPct = Math.min(
                    aCountdownPct,
                    this.mCountdownBarPct + (aCountdownPct - this.mCountdownBarPct) * 0.0275 + 0.00125
                );
            } else {
                this.mCountdownBarPct = Math.min(
                    aCountdownPct,
                    this.mCountdownBarPct + (aCountdownPct - this.mCountdownBarPct) * 0.025 + 0.0005
                );
            }
        } else {
            this.mCountdownBarPct = Math.max(
                aCountdownPct,
                this.mCountdownBarPct + (aCountdownPct - this.mCountdownBarPct) * 0.05 - 0.0001
            );
        }
    ...
    GetRandSeedOverride: function Game_Board$GetRandSeedOverride() {
        if (
            this.mTutorialMgr.GetTutorialSequence() != null &&
            this.mTutorialMgr.GetTutorialSequence().mBoardSeed != 0
        ) {
    ...
    GetTooltipText: function Game_Board$GetTooltipText(thePiece, theHeader, theBody) {
        ...
        if (thePiece.IsFlagSet(Game.Piece.EFlag.FLAME)) {
            if (thePiece.IsFlagSet(Game.Piece.EFlag.LASER)) {
                ...
                theBody =
                    "Created by matching 6+ Gems in a row, this powerful Gem explodes with the force of a million suns when matched.";
            } else {
                theHeader = "FLAME GEM";
    ...
    UpdatePoints: function Game_Board$UpdatePoints() {
        if (this.mUpdateCnt % 4 == 0) {
            if (this.mDispPoints < this.mPoints) {
                this.mDispPoints =
                    Math.min(this.mPoints, this.mDispPoints + (((this.mPoints - this.mDispPoints) * 0.2) | 0) + 1) | 0;
            } else if (this.mDispPoints > this.mPoints) {
                this.mDispPoints =
                    Math.max(this.mPoints, this.mDispPoints + (((this.mPoints - this.mDispPoints) * 0.2) | 0) - 1) | 0;
            }
        }
    },
    UpdateGame: function Game_Board$UpdateGame() {
...

        {
            ...
            for (var $enum23 = 0; $enum23 < $srcArray23.length; $enum23++) {
                ...
                if (aPiece != null) {
                    ...
                    if (
                        (aPiece.IsFlagSet(Game.Piece.EFlag.BOMB) ||
                            aPiece.IsFlagSet(Game.Piece.EFlag.REALTIME_BOMB) ||
                            aPiece.IsFlagSet(Game.Piece.EFlag.DOOM)) &&
                        aPiece.mCounter == 0 &&
                        this.mIsBoardStill
                ...
                if (aPiece_2 != null && aPiece_2.mExplodeDelay > 0 && --aPiece_2.mExplodeDelay == 0) {
                    if (aPiece_2.IsFlagSet(Game.Piece.EFlag.INFERNO_SWAP)) {
                        ...
                        if (
                            ...
                            (aPiece_2.IsFlagSet(Game.Piece.EFlag.LASER) && aPiece_2.mImmunityCount > 0)
                        ) {
                            if (aPiece_2.IsFlagSet(Game.Piece.EFlag.BLAST_GEM)) {
                                ...
                                this.AddPoints(
                                    ...
                                    aPiece_2.CY() | 0,
                                    1000 * aBlastCount,
                                    Game.DM.gGemColors[aPiece_2.mColor | 0],
                                    aPiece_2.mMatchId,
                                    false,
                                    false,
                                    -1,
...

                                {
                                    ...
                                    for (var $enum25 = 0; $enum25 < $srcArray25.length; $enum25++) {
                                        ...
                                        if (
                                            aSubPiece != null &&
                                            (aSubPiece.IsFlagSet(Game.Piece.EFlag.FLAME) ||
                                                aSubPiece.IsFlagSet(Game.Piece.EFlag.HYPERCUBE) ||
                                                aSubPiece.IsFlagSet(Game.Piece.EFlag.LASER) ||
                                                aSubPiece.IsFlagSet(Game.Piece.EFlag.COIN) ||
                                                aSubPiece.IsFlagSet(Game.Piece.EFlag.POINT_MULTIPLIER) ||
                                                aSubPiece.IsFlagSet(Game.Piece.EFlag.BLAST_GEM))
                                        ) {
                            ...
                            this.AddPoints(
                                ...
                                aPiece_2.CY() | 0,
                                20,
                                GameFramework.gfx.Color.WHITE_RGB,
                                aPiece_2.mMatchId,
                                true,
                                true,
                                aPiece_2.mMoveCreditId,
                                false,
                                Game.Board.EPointType.SPECIAL
                            );
                            this.ExplodeAt(aPiece_2.CX() | 0, aPiece_2.CY() | 0);
                            ...
                            (aPiece_2.IsFlagSet(Game.Piece.EFlag.HYPERCUBE) ||
                                ...
                                aPiece_2.IsFlagSet(Game.Piece.EFlag.COIN) ||
                                aPiece_2.IsFlagSet(Game.Piece.EFlag.POINT_MULTIPLIER)) &&
                            this.TriggerSpecialEx(aPiece_2, null)
                        ) {
                        } else {
        ...
        if (doBoom) {
            if (this.WantsCalmEffects()) {
                if (anExplodeCount > 0) {
                    ...
                    Game.SoundUtil.PlayEx(
                        Game.Resources["SOUND_GEM_SHATTERS"],
                        this.GetPanPosition((anExplodeAccumX / anExplodeCount) | 0),
                        0.5
                    );
                }
            ...
            for (var $enum28 = 0; $enum28 < $srcArray28.length; $enum28++) {
                ...
                if (aPiece_5 != null) {
                    if (aPiece_5.mDestPct.get_v() != 0.0) {
                        aPiece_5.mX =
                            this.GetColX(aPiece_5.mCol) * (1.0 - aPiece_5.mDestPct.get_v()) +
                            this.GetColX(aPiece_5.mDestCol) * aPiece_5.mDestPct.get_v();
                        aPiece_5.mY =
                            this.GetRowY(aPiece_5.mRow) * (1.0 - aPiece_5.mDestPct.get_v()) +
                            this.GetRowY(aPiece_5.mDestRow) * aPiece_5.mDestPct.get_v();
                    } else {
        ...
        if (this.mIsBoardStill) {
            ...
            if (
                this.mGameOverCount == 0 &&
                !this.ForceSwaps() &&
                !this.FindMove(null, 0, true, true, false, null, false) &&
                !this.mWantLevelup
            ) {
                this.GameOver();
            }
        ...
        if (this.mIsBoardStill) {
            var aMovesPerSecond = Math.max(
                0.1,
                this.mGameStats[Game.DM.EStat.NUM_MOVES | 0] / (this.mGameTicks / 60.0)
            );
            if (
                (GameFramework.Utils.GetRandFloatU() < 0.01 && this.mLastSunTick == 0 && this.mUpdateCnt >= 50) ||
                (GameFramework.BaseApp.mApp.mCurFPS >= 45 &&
                    GameFramework.Utils.GetRandFloatU() < 0.003 * aMovesPerSecond &&
                    !this.mSunFired) ||
                (GameFramework.BaseApp.mApp.mCurFPS >= 45 &&
                    GameFramework.Utils.GetRandFloatU() < 0.0006 * aMovesPerSecond)
            ) {
        ...
        if (this.mFlameSound != null) {
            this.mFlameSound.SetVolume(
                Math.max(
                    this.mFlameSoundBlazingVol.GetOutVal(),
                    Math.max(0.0, 1.0 - (1.0 - this.mSpeedBonusNum) * 2.5)
                ) *
                    this.mAlpha.GetOutVal() *
                    this.GetPieceAlpha()
            );
        }
        {
                ...
                if (this.GetLevelPct() < 0.95) {
                    ...
                    if (Game.BejApp.mBejApp.mAutoLevelUpCount == 1) {
                        for (var i_2 = 0; i_2 < 3; ++i_2) {
                            var randPiece = this.GetPieceAtRowCol(
                                Game.Util.Rand() % this.mRowCount,
                                Game.Util.Rand() % this.mColCount
                            );
            ...
            if (
                !this.WantFreezeAutoplay() &&
                Game.BejApp.mBejApp.mAutoPlay != Game.DM.EAutoplay.None &&
                this.CanPlay() &&
                ((this.IsBoardStill() && Game.Util.Rand() % 40 == 0) ||
                    Game.BejApp.mBejApp.mAutoPlay == Game.DM.EAutoplay.NoDelay ||
                    Game.BejApp.mBejApp.mAutoPlay == Game.DM.EAutoplay.NoDelayWithInvalidMoves ||
                    Game.BejApp.mBejApp.mAutoPlay == Game.DM.EAutoplay.TestHyper ||
                    Game.Util.Rand() % 60 == 0)
            ) {
                ...
                if (Game.Util.Rand() % 8 < 8) {
                    ...
                    if (
                        (Game.BejApp.mBejApp.mAutoPlay == Game.DM.EAutoplay.TestHyper &&
                            this.FindRandomMoveCoords(aCoords, true)) ||
                        this.FindRandomMove(aCoords)
                    ) {
                ...
                if (
                    ...
                    (Game.BejApp.mBejApp.mAutoPlay == Game.DM.EAutoplay.NoDelayWithInvalidMoves &&
                        this.mUpdateCnt % 1 == 0) ||
                    (Game.BejApp.mBejApp.mAutoPlay == Game.DM.EAutoplay.TestHyper && this.mUpdateCnt % 40 == 0)
                ) {
                    var aPiece_7 =
                        this.mBoard[
                            this.mBoard.mIdxMult0 * (Game.Util.Rand() % this.mRowCount) +
                                (Game.Util.Rand() % this.mColCount)
                        ];
                    if (aPiece_7 != null) {
                        var anOffsets = Array.Create2D(4, 2, 0, -1, 0, 1, 0, 0, -1, 0, 1);
                        ...
                        this.QueueSwap(
                            aPiece_7,
                            aPiece_7.mRow + anOffsets[anOffsets.mIdxMult0 * aDir + 1],
                            aPiece_7.mCol + anOffsets[anOffsets.mIdxMult0 * aDir + 0],
                            false,
                            true
                        );
                    }
    ...
    DoUpdate: function Game_Board$DoUpdate() {
        ...
        if (
            (this.mUserPaused ||
                (Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.QUEST_HELP) != null &&
                    this.mTimerAlpha.GetOutVal() == 1.0) ||
                Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.OPTIONS) != null ||
                Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.MAIN_MENU_CONFIRM) != null ||
                Game.BejApp.mBejApp.GetDialog(Game.DM.EDialog.RESET) != null) &&
            this.WantsHideOnPause()
        ...
        if (
            this.mAlpha.get_v() == 1 &&
            this.mScale.get_v() == 1 &&
            Game.DialogMgr.mDialogMgr.mDialogList.length == 0 &&
            this.mGameOverCount == 0 &&
            this.mHasBoardSettled &&
            !this.IsTutorialBusy()
        ) {
            if (this.mReadyDelayCount > 0) {
            ...
            if (
                (this.mTimerInflate.get_v() == 0 || this.GetTimeLimit() == 0 || this.mGoDelayCount > 1) &&
                this.mGoDelayCount >= 0 &&
                --this.mGoDelayCount == 0
            ) {
            ...
            if (this.mUpdateCnt >= aQueuedMove.mUpdateCnt) {
                if (aQueuedMove.mUpdateCnt == this.mUpdateCnt) {
                    ...
                    if (aSelectedPiece != null) {
                        this.TrySwapEx(
                            aSelectedPiece,
                            aQueuedMove.mSwappedRow,
                            aQueuedMove.mSwappedCol,
                            aQueuedMove.mForceSwap,
                            aQueuedMove.mPlayerSwapped,
                            false,
                            aQueuedMove.mDragSwap
                        );
                    }
                }
    ...
    Update: function Game_Board$Update() {
        ...
        if (
            Game.BejApp.mBejApp.mDialogMgr.GetDialog(Game.DM.EDialog.OPTIONS) == null &&
            Game.BejApp.mBejApp.mDialogMgr.GetDialog(Game.DM.EDialog.RESET) == null
        ) {
        ...
        if (GameFramework.BaseApp.mApp.get_Is3D() && !Game.BejApp.mBejApp.mIsSlow) {
            GameFramework.BaseApp.mApp.mResourceManager.PauseStreaming(
                this.mHyperspace == null || this.mHyperspace.mUpdateCnt < 96
            );
        } else {
            GameFramework.BaseApp.mApp.mResourceManager.PauseStreaming(this.mHyperspace == null);
        }
        if (this.mBackground != null) {
            this.mBackground.mVisible =
                !Game.BejApp.mBejApp.mMainMenu.IsTransitioning() || !GameFramework.BaseApp.mApp.get_Is3D();
        }
        if (!this.AllowUI()) {
            this.DisableUI(true);
        }
        ...
        if (this.mBackground != null) {
            this.mBackground.mWantAnim =
                (this.mHyperspace == null || this.mScale.get_v() == 1.0) &&
                this.GetAlpha() == 1.0 &&
                this.mScale.get_v() == 1.0 &&
                this.mHasBoardSettled &&
                Game.BejApp.mBejApp.mDialogMgr.mDialogList.length == 0;
        }
        if (this.mUpdateCnt % 60 == 0) {
            ...
            if (
                GameFramework.BaseApp.mApp.mCurFPS < this.mLevelStats[Game.DM.EStat.FPS_MIN | 0] ||
                this.mLevelStats[Game.DM.EStat.FPS_MIN | 0] == 0
            ) {
                this.mLevelStats[Game.DM.EStat.FPS_MIN | 0] = GameFramework.BaseApp.mApp.mCurFPS;
            }
            if (
                GameFramework.BaseApp.mApp.mCurFPS < this.mGameStats[Game.DM.EStat.FPS_MIN | 0] ||
                this.mGameStats[Game.DM.EStat.FPS_MIN | 0] == 0
            ) {
    ...
    DrawGemLighting: function Game_Board$DrawGemLighting(g, thePiece) {
        if (
            !GameFramework.BaseApp.mApp.get_Is3D() ||
            thePiece.mColor == Game.DM.EGemColor.HYPERCUBE ||
            thePiece.mScale.get_v() != 1.0 ||
            thePiece.mRotPct != 0.0 ||
            this.GetPieceAlpha() != 1.0
        ) {
            return;
        }
...

            {
                ...
                for (var $enum34 = 0; $enum34 < $srcArray34.length; $enum34++) {
                    ...
                    }
                    {
                        ...
                        var anIntensity = Math.min(
                            anEffect.mValue[2],
                            anEffect.mValue[0] / Math.max(1.0, aDistSq + anEffect.mValue[1])
                        );
                        if (anIntensity <= 0.2) {
                            continue;
                        }
            ...
            if (aLights != null) {
                ...
                for (var aLightDir = 0; aLightDir < aLights.length; aLightDir++) {
                    if (aLights[aLightDir] != 0.0 && thePiece.mColor != Game.DM.EGemColor.HYPERCUBE) {
                        ...
                        try {
                            g.DrawImageCel(
                                Game.Resources["IMAGE_GEMLIGHTING"].get_OffsetImage(),
                                anOfsX,
                                anOfsY,
                                (thePiece.mColor | 0) * 9 + aLightDir
                            );
                        } finally {
                            _t35.Dispose();
                        }
    ...
    DrawHypercube: function Game_Board$DrawHypercube(g, thePiece) {
        ...
        g.DrawImageCel(
            Game.Resources["IMAGE_HYPERCUBE_FRAME"].get_OffsetImage(),
            thePiece.GetScreenX() - 16,
            thePiece.GetScreenY() - 16,
            aHyperFrame
        );
        //JS
        ...
        g.DrawImageCel(
            img.get_OffsetImage(),
            img.mOffsetX + thePiece.GetScreenX() - 16,
            img.mOffsetY + thePiece.GetScreenY() - 16,
            aHyperFrame
        );
        img.mAdditive = false;
        g.PopColor();
    ...
    DrawPieceShadow: function Game_Board$DrawPieceShadow(g, thePiece) {
        ...
        if (aScale != 1.0) {
            g.PushScale(
                aScale,
                aScale,
                thePiece.GetScreenX() + ((Game.Board.GEM_WIDTH / 2) | 0),
                thePiece.GetScreenY() + ((Game.Board.GEM_HEIGHT / 2) | 0)
            );
        }
        var anAlpha;
        ...
        if (thePiece.IsFlagSet(Game.Piece.EFlag.POINT_MULTIPLIER)) {
            var aFrame =
                Math.min(
                    thePiece.mRotPct * Game.Resources["IMAGE_GEMS_RED"].mNumFrames,
                    Game.Resources["IMAGE_GEMS_RED"].mNumFrames - 1
                ) | 0;
            g.DrawImageCel(
                Game.BejUtil.GetGemColorImageShadow(thePiece.mColor).get_OffsetImage(),
                anOfsX,
                anOfsY,
                aFrame
            );
        } else if (
            ((thePiece.mColor | 0) > -1 && (thePiece.mColor | 0) < 7) ||
            thePiece.IsFlagSet(Game.Piece.EFlag.LASER)
        ) {
            var aFrame_2 =
                Math.min(
                    (thePiece.mRotPct * Game.Resources["IMAGE_GEMS_RED"].mNumFrames) | 0,
                    Game.Resources["IMAGE_GEMS_RED"].mNumFrames - 1
                ) | 0;
            g.DrawImageCel(
                Game.BejUtil.GetGemColorImageShadow(thePiece.mColor).get_OffsetImage(),
    ...
    DrawPiece: function Game_Board$DrawPiece(g, thePiece, theScale, fromHyperspace) {
        ...
        if (this.mShowMoveCredit) {
            ...
            if (thePiece.mMoveCreditId != -1) {
                g.DrawString(
                    GameFramework.Utils.ToString(thePiece.mMoveCreditId),
                    thePiece.GetScreenX() + 10,
                    thePiece.GetScreenY() + 20
                );
            }
            if (thePiece.mCounter != 0) {
                g.DrawString(
                    GameFramework.Utils.ToString(thePiece.mCounter),
                    thePiece.GetScreenX() + 80,
                    thePiece.GetScreenY() + 20
                );
            }
            g.PopColor();
        ...
        if (drawGem && thePiece.mColor >= 0) {
            if (this.CanBakeShadow(thePiece)) {
                g.DrawImageCel(
                    Game.Resources["IMAGE_GEMS_SHADOWED"].get_OffsetImage(),
                    anOfsX,
                    anOfsY,
                    thePiece.mColor | 0
                );
            } else {
                var gemColors = Array.Create(
                    7,
                    null,
                    GameFramework.gfx.Color.RGBToInt(255, 255, 255),
                    GameFramework.gfx.Color.RGBToInt(192, 192, 192),
                    GameFramework.gfx.Color.RGBToInt(32, 192, 32),
                    GameFramework.gfx.Color.RGBToInt(224, 192, 32),
                    GameFramework.gfx.Color.RGBToInt(255, 255, 255),
                    GameFramework.gfx.Color.RGBToInt(255, 160, 32),
                    GameFramework.gfx.Color.RGBToInt(255, 255, 255)
                );
                if (thePiece.IsFlagSet(Game.Piece.EFlag.LASER)) {
                    g.PushColor(
                        GameFramework.gfx.Color.UInt_AToInt(
                            gemColors[thePiece.mColor | 0],
                            (255.0 * thePiece.mAlpha.get_v() * this.GetPieceAlpha()) | 0
                        )
                    );
                }
        ...
        if (thePiece.mHidePct > 0) {
            ...
            g.FillRect(
                thePiece.GetScreenX() + 1,
                thePiece.GetScreenY() + 1,
                Game.Board.GEM_WIDTH - 2,
    ...
    DrawTopFrame: function Game_Board$DrawTopFrame(g) {
        ...
        if (this.WantTopFrame()) {
            g.DrawImage(
                Game.Resources["IMAGE_BOARD_TOP_FRAME"].get_CenteredImage(),
                this.GetBoardCenterX(),
                this.GetBoardY() - 5
            );
    ...
    DrawBottomFrame: function Game_Board$DrawBottomFrame(g) {
        if (this.WantCountdownBar()) {
            ...
            if (this.WantBottomFrame()) {
                var _t39 = g.PushColor(
                    GameFramework.gfx.Color.RGBAToInt(255, 255, 255, (255.0 * this.GetBoardAlpha()) | 0)
                );
                try {
                    g.DrawImage(
                        Game.Resources["IMAGE_BOARD_BOTTOM_FRAME"].get_CenteredImage(),
                        this.GetBoardCenterX(),
                        this.GetBoardY() + Game.Board.GEM_HEIGHT * this.mRowCount + 33
                    );
                } finally {
                    _t39.Dispose();
                }
            ...
            var _t41 = g.PushColor(
                GameFramework.gfx.Color.RGBAToInt(255, 255, 255, (255.0 * this.GetBoardAlpha()) | 0)
            );
            try {
                g.DrawImage(
                    Game.Resources["IMAGE_BOARD_THIN_BOTTOM_FRAME"].get_CenteredImage(),
                    this.GetBoardCenterX(),
                    this.GetBoardY() + Game.Board.GEM_HEIGHT * this.mRowCount + 11
                );
            } finally {
                _t41.Dispose();
            }
        ...
        if (this.WantBottomFrame() && this.WantWarningGlow()) {
            ...
            try {
                if (this.WantBottomLevelBar() || this.GetTimeLimit() > 0) {
                    g.DrawImage(
                        Game.Resources["IMAGE_BOARD_BOTTOM_FRAME_GLOW"].get_CenteredImage(),
                        this.GetBoardCenterX(),
                        this.GetBoardY() + Game.Board.GEM_HEIGHT * this.mRowCount + 33
                    );
                } else {
                    g.DrawImage(
                        Game.Resources["IMAGE_BOARD_THIN_BOTTOM_FRAME_GLOW"].get_CenteredImage(),
                        this.GetBoardCenterX(),
                        this.GetBoardY() + Game.Board.GEM_HEIGHT * this.mRowCount + 11
                    );
                }
    ...
    DrawLevelBar: function Game_Board$DrawLevelBar(g) {
        ...
        try {
            g.DrawImage(
                Game.Resources["IMAGE_BOARD_BOTTOM_FRAME_BACK"].get_CenteredImage(),
                this.GetBoardCenterX(),
                this.GetBoardY() + 1054
            );
            var aBarRect = this.GetLevelBarRect();
            ...
            }
            {
                for (var aBarIdx = 0; aBarIdx < this.mBarInstanceVector.length; aBarIdx++) {
                    ...
                    var anImageInst = Game.Resources["IMAGE_BARFILL"].CreateImageInstRect(
                        (aBarInstance.mSrcX * 1000 * g.mScale) | 0,
                        (aBarInstance.mSrcY * 210 * g.mScale) | 0,
    ...
    DrawCountdownBar: function Game_Board$DrawCountdownBar(g) {
        ...
        try {
            ...
            if (this.mLevelBarBonusAlpha.get_v() > 0) {
                ...
                var _t50 = g.PushColor(
                    GameFramework.gfx.Color.RGBAToInt(240, 255, 200, (this.mLevelBarBonusAlpha.get_v() * 255.0) | 0)
                );
                try {
    ...
    DrawComplements: function Game_Board$DrawComplements(g) {
        if (this.mComplementAlpha.get_v() != 0 && this.mComplementNum != -1 && GameFramework.BaseApp.mApp.get_Is3D()) {
            var gWordId = Array.Create(
                7,
                "",
                Game.Resources.IMAGE_COMPLEMENT_GOOD_ID,
                Game.Resources.IMAGE_COMPLEMENT_EXCELLENT_ID,
                Game.Resources.IMAGE_COMPLEMENT_AWESOME_ID,
                Game.Resources.IMAGE_COMPLEMENT_SPECTACULAR_ID,
                Game.Resources.IMAGE_COMPLEMENT_EXTRAORDINARY_ID,
                Game.Resources.IMAGE_COMPLEMENT_UNBELIEVABLE_ID,
            ...
            g.DrawImage(
                GameFramework.BaseApp.mApp.mResourceManager
                    .GetImageResourceById(gWordId[this.mComplementNum])
                    .get_CenteredImage(),
                this.GetBoardCenterX(),
                450.0
            );
    ...
    DrawPointMultiplier: function Game_Board$DrawPointMultiplier(g, front) {
        ...
        if (!front) {
            ...
            if (
                this.mPointMultPosPct.get_v() == 1 &&
                (this.mPointMultiplier >= 1 || (this.mTimeExpired && this.mPointMultiplier > 0))
            ) {
                Game.Resources["FONT_MULTIPLIER"].PushLayerColor(
                    "MAIN",
                    GameFramework.gfx.Color.RGBAToInt(255, 255, 255, 230)
                );
                Game.Resources["FONT_MULTIPLIER"].PushLayerColor(
                    "OUTLINE",
                    GameFramework.gfx.Color.RGBAToInt(128, 0, 80, 230)
                );
                Game.Resources["FONT_MULTIPLIER"].PushLayerColor(
                    "GLOW",
                    GameFramework.gfx.Color.RGBAToInt(255, 0, 160, 128)
                );
                ...
                try {
                    g.DrawString(
                        aString,
                        aMultX -
                            Game.Resources["FONT_MULTIPLIER"].StringWidth(aString) * 0.5 +
                            Game.DM.UI_SLIDE_LEFT * this.mSlideUIPct.get_v() +
                            this.mPointMultSidebarOffset.x,
                        aMultY + 20 + this.mPointMultSidebarOffset.y
                    );
                } finally {
                    _t51.Dispose();
                }
        ...
        if (
            this.mPointMultiplier > 1 &&
            (this.mPointMultTextMorph.IsDoingCurve() || this.mPointMultAlpha.IsDoingCurve())
        ) {
            ...
            if (this.mTimeExpired) {
                aPoint.x =
                    Math.max(0.0, 1.0 - this.mPointMultPosPct.get_v()) * aSrcPos.x +
                    Math.max(0.0, this.mPointMultPosPct.get_v()) * aSidebarPos.x;
                aPoint.y =
                    Math.max(0.0, 1.0 - this.mPointMultPosPct.get_v()) * aSrcPos.y +
                    Math.max(0.0, this.mPointMultPosPct.get_v()) * aSidebarPos.y;
            } else {
                aPoint.x =
                    Math.max(0.0, 1.0 - this.mPointMultPosPct.get_v() * 2.0) * aSrcPos.x +
                    (1.0 - Math.abs((this.mPointMultPosPct.get_v() - 0.5) * 2)) * aCenterPos.x +
                    Math.max(0.0, 2 * (this.mPointMultPosPct.get_v() - 0.5)) * aSidebarPos.x;
                aPoint.y =
                    Math.max(0.0, 1.0 - this.mPointMultPosPct.get_v() * 2.0) * aSrcPos.y +
                    (1.0 - Math.abs((this.mPointMultPosPct.get_v() - 0.5) * 2)) * aCenterPos.y +
                    Math.max(0.0, 2 * (this.mPointMultPosPct.get_v() - 0.5)) * aSidebarPos.y;
            }
            ...
            if (this.mPointMultiplier <= 9) {
                var aColor = GameFramework.Utils.LerpColor(
                    this.mPointMultColor,
                    0xffffff,
                    this.mPointMultAlpha.get_v()
                );
                aColor = GameFramework.gfx.Color.UInt_AToInt(
                    aColor,
                    (255 *
                        this.GetPieceAlpha() *
                        (1.0 - this.mSlideUIPct.get_v()) *
                        this.mPointMultAlpha.get_v() *
                        (1.0 - this.mPointMultTextMorph.get_v()) *
                        0.5) |
                        0
                );
                g.PushColor(aColor);
                g.DrawImageCel(
                    Game.Resources["IMAGE_MULTIPLIER_LARGE_BACK"].get_CenteredImage(),
                    aPoint.x,
                    aPoint.y,
                    (Math.min(9, this.mPointMultiplier) - 1) | 0
                );
                g.PopColor();
                aColor = GameFramework.gfx.Color.UInt_AToInt(
                    aColor,
                ...
                g.PushColor(aColor);
                g.DrawImageCel(
                    Game.Resources["IMAGE_MULTIPLIER_LARGE_FRONT"].get_CenteredImage(),
                    aPoint.x,
                    aPoint.y,
                    (Math.min(9, this.mPointMultiplier) - 1) | 0
                );
    ...
    DrawOverlay: function Game_Board$DrawOverlay(g) {
        ...
        if (this.mBoardDarken > 0) {
            ...
            g.PushColor(
                GameFramework.gfx.Color.RGBAToInt(0, 0, 0, (this.GetBoardAlpha() * this.mBoardDarken * 128.0) | 0)
            );
        ...
        if (this.mTutorialMgr.IsBusy() && this.mScale.get_v() == 1.0) {
            ...
            try {
                var _t53 = g.PushTranslate(
                    this.mMenuButton.mX + ((this.mSideXOff.get_v() * 4.0) | 0),
                    this.mMenuButton.mY
                );
                try {
    ...
    Draw: function Game_Board$Draw(g) {
        ...
        try {
            ...
            var aC1Normal = GameFramework.gfx.Color.UInt_AToInt(
                this.mBoardColors[0],
                (((0xff000000 & this.mBoardColors[0]) >>> 24) * this.GetBoardAlpha()) | 0
            );
            var aC1Blaze = GameFramework.gfx.Color.RGBAToInt(
                180,
                100 + ((Math.sin(anAng) * 14) | 0),
                48 + ((Math.sin(anAng) * 8) | 0),
                (200 * this.GetBoardAlpha()) | 0
            );
            var aC1 = GameFramework.Utils.LerpColor(
                aC1Normal,
                aC1Blaze,
                Math.min(1.0, this.mSpeedBonusFlameModePct * 5.0)
            );
            var aC2Normal = GameFramework.gfx.Color.UInt_AToInt(
                this.mBoardColors[1],
                (((0xff000000 & this.mBoardColors[1]) >>> 24) * this.GetBoardAlpha()) | 0
            );
            var aC2Blaze = GameFramework.gfx.Color.RGBAToInt(
                160,
                90 + ((Math.sin(anAng) * 12) | 0),
                40 + ((Math.sin(anAng) * 7) | 0),
                (200 * this.GetBoardAlpha()) | 0
            );
            var aC2 = GameFramework.Utils.LerpColor(
                aC2Normal,
                aC2Blaze,
                Math.min(1.0, this.mSpeedBonusFlameModePct * 5.0)
            );
            ...
            if (this.mWarningGlowAlpha > 0.0) {
                ...
                var _t55 = g.PushColor(
                    GameFramework.gfx.Color.UInt_FAToInt(this.mWarningGlowColor, this.mWarningGlowAlpha)
                );
                try {
                    ...
                    try {
                        g.DrawImage(
                            ...
                            bx + ((bw / 2) | 0),
                            bh + ((Game.Resources["IMAGE_DANGERBORDERUP"].mHeight / 2) | 0)
                        );
                    } finally {
                        _t56.Dispose();
                    }
        ...
        try {
            switch (this.mUiConfig) {
                case Game.Board.EUIConfig.Standard: {
                    g.DrawImage(
                        Game.Resources["IMAGE_BOARD_BOTTOM_WIDGET_CLASSIC"].get_OffsetImage(),
                        this.mWidescreenX,
                        this.GetBottomWidgetOffset()
                    );
                    break;
                }
                case Game.Board.EUIConfig.WithReset: {
                    g.DrawImage(
                        Game.Resources["IMAGE_BOARD_BOTTOM_WIDGET_LIGHTNING"].get_OffsetImage(),
                        this.mWidescreenX,
                        this.GetBottomWidgetOffset()
                    );
                    break;
    ...
    DrawTimer: function Game_Board$DrawTimer(g) {
        ...
        if (this.mTimerInflate.get_v() > 0) {
            ...
            try {
                var _t59 = g.PushColor(
                    GameFramework.gfx.Color.RGBAToInt(
                        ...
                        (255.0 *
                            this.GetAlpha() *
                            this.mTimerAlpha.get_v() *
                            (1.0 - this.mVisPausePct * this.mTimerInflate.get_v())) |
                            0
                    )
                );
                try {
            ...
            var _t60 = g.PushColor(
                GameFramework.gfx.Color.RGBAToInt(
                    255,
                    255,
                    255,
                    (255.0 * this.GetAlpha() * this.mTimerAlpha.get_v()) | 0
                )
            );
            try {
    ...
    DrawButtons: function Game_Board$DrawButtons(g) {
        ...
        if (this.mZenOptionsButton != null) {
            g.PushTranslate(
                this.mZenOptionsButton.mX + ((this.mSideXOff.get_v() * 4.0) | 0),
                this.mZenOptionsButton.mY
            );
    ...
    DrawSpeedBonusDynImage: function Game_Board$DrawSpeedBonusDynImage(g) {
        ...
        var _t61 = g.PushScale(
            this.mSpeedBonusPointsScale.GetOutVal(),
            this.mSpeedBonusPointsScale.GetOutVal(),
            244,
            100
        );
        try {
            var _t62 = g.PushColor(
                GameFramework.gfx.Color.RGBAToInt(
                    255,
                    255,
                    255,
                    (255.0 * this.GetAlpha() * this.mSideAlpha.get_v()) | 0
                )
            );
            try {
                Game.Resources["FONT_SPEED_SCORE"].PushLayerColor("OUTLINE", GameFramework.gfx.Color.BLACK_RGB);
                Game.Resources["FONT_SPEED_SCORE"].PushLayerColor(
                    "GLOW",
                    GameFramework.gfx.Color.FAlphaToInt(this.mSpeedBonusPointsGlow.GetOutVal())
                );
                ...
                g.DrawStringCentered(
                    String.format(
                        "{0} MATCH CHAIN",
                        this.mSpeedBonusCount == 0 ? this.mSpeedBonusLastCount : this.mSpeedBonusCount
                    ),
                    244,
                    120
                );
                if (this.mSpeedBonusTextShowPct.get_v() > 0.0 || this.mSpeedBonusCount > 0) {
                    ...
                    var fullString = String.format(
                        "SPEED +{0}",
                        (Math.min(
                            200.0,
                            ((this.mSpeedBonusCount == 0 ? this.mSpeedBonusLastCount : this.mSpeedBonusCount) + 1.0) *
                                20.0
                        ) *
                            this.GetModePointMultiplier()) |
                            0
                    );
                    var fullStringW = g.GetFont().StringWidth(fullString);
                    if (this.mSpeedBonusTextShowPct.get_v() > 0.0) {
                        var _t63 = g.PushScale(
                            this.mSpeedBonusTextShowPct.get_v(),
                            this.mSpeedBonusTextShowPct.get_v(),
                            244.0,
                            96.0 - g.GetFont().GetHeight() / 2
                        );
                        try {
                                ...
                                if (pctStringLastLetter.length > 0) {
                                    ...
                                    try {
                                        g.DrawString(
                                            ...
                                            244 -
                                                fullStringW / 2 +
                                                g.GetFont().StringWidth(pctString + "0") -
                                                g.GetFont().StringWidth("0"),
                                            66
                                        );
                                    } finally {
                                        _t65.Dispose();
...

                {
                    ...
                    for (var $enum70 = 0; $enum70 < $srcArray70.length; $enum70++) {
                        ...
                        if (aPiece != null && aPiece.mHintAlpha.get_v() != 0) {
                            var _t71 = g.PushColor(
                                GameFramework.gfx.Color.RGBAToInt(
                                    255,
                                    255,
                                    255,
                                    (this.GetPieceAlpha() * aPiece.mHintAlpha.get_v() * 255.0) | 0
                                )
                            );
                            try {
                                var aTrans = new GameFramework.geom.Matrix();
                                aTrans.translate(0, aPiece.mHintArrowPos.get_v());
                                var aOfs = Array.Create(
                                    4,
                                    null,
                                    new GameFramework.geom.TPoint(1, 0),
                                    new GameFramework.geom.TPoint(0, 0),
                                    new GameFramework.geom.TPoint(0, 0),
                                    new GameFramework.geom.TPoint(0, 1)
                                );
                                for (var i = 0; i < 4; i++) {
    ...
    DrawPieces: function Game_Board$DrawPieces(g, thePostFX) {
        ...
        if (!thePostFX) {
            {
                ...
                for (var $enum72 = 0; $enum72 < $srcArray72.length; $enum72++) {
                    ...
                    if (
                        aPiece != null &&
                        !aPiece.IsFlagSet(Game.Piece.EFlag.FLAME) &&
                        !aPiece.IsFlagSet(Game.Piece.EFlag.TIME_BONUS) &&
                        !this.CanBakeShadow(aPiece)
                    ) {
...

        {
            ...
            for (var $enum73 = 0; $enum73 < $srcArray73.length; $enum73++) {
                ...
                if (
                    aPiece_2 != null &&
                    !this.IsPieceSwapping(aPiece_2) &&
                    aPiece_2 != this.mGameOverPiece &&
                    (!thePostFX ||
                        aPiece_2.mElectrocutePercent > 0 ||
                        (gemMask & ((1 << ((aPiece_2.mColor | 0) + 1)) | 0)) != 0) &&
                    (!thePostFX ||
                        (!aPiece_2.IsFlagSet(Game.Piece.EFlag.SCRAMBLE) &&
                            !aPiece_2.IsFlagSet(Game.Piece.EFlag.DETONATOR)))
                ) {
...

        {
            ...
            for (var $enum74 = 0; $enum74 < $srcArray74.length; $enum74++) {
                ...
                if (
                    aPiece_3 != null &&
                    !this.IsPieceSwapping(aPiece_3) &&
                    aPiece_3 != this.mGameOverPiece &&
                    (!thePostFX ||
                        aPiece_3.mElectrocutePercent > 0 ||
                        (gemMask & ((1 << ((aPiece_3.mColor | 0) + 1)) | 0)) != 0) &&
                    (!thePostFX ||
                        (!aPiece_3.IsFlagSet(Game.Piece.EFlag.SCRAMBLE) &&
                            !aPiece_3.IsFlagSet(Game.Piece.EFlag.DETONATOR)))
                ) {
        ...
        for (var i = 0; i < (this.mSwapDataVector.length | 0); i++) {
            ...
            if (
                !aSwapData.mDestroyTarget &&
                aSwapData.mPiece2 != null &&
                aSwapData.mSwapPct.get_v() <= Game.MathUtil.PI
            ) {
        ...
        if (this.mCursorSelectPos.x != -1 && this.GetSelectedPiece() == null) {
            ...
            g.DrawImage(
                Game.Resources["IMAGE_SELECTOR"],
                this.GetBoardX() + this.GetColX(this.mCursorSelectPos.x),
                this.GetBoardY() + this.GetRowY(this.mCursorSelectPos.y)
            );
            g.PopColor();
        }
    },
    DrawIris: function Game_Board$DrawIris(g, theCX, theCY, theAlpha, theScale) {
        theAlpha *= this.GetBoardAlpha();
        {
            ...
            var aDestRect = new GameFramework.TRect(
                theCX - ((aWidth / 2) | 0),
                theCY - ((aHeight / 2) | 0),
                aWidth,
                aHeight
            ...
            g.FillRect(
                ...
                aDestRect.mY,
                this.mWidth - (aDestRect.mX + aDestRect.mWidth),
                aDestRect.mHeight
            );
            g.FillRect(
                0,
                aDestRect.mY + aDestRect.mHeight,
                this.mWidth,
                this.mHeight - (aDestRect.mY + aDestRect.mHeight)
            );
            g.PopColor();
        }
    },
    ...
    DrawTopWidget: function Game_Board$DrawTopWidget(g) {
        ...
        try {
            ...
            g.DrawStringEx(
                GameFramework.Utils.CommaSeperate(this.mLevel + 1),
                this.GetLeftUIOffsetX() + 243,
                250,
                0,
                0
            );
    ...
    MouseDown: function Game_Board$MouseDown(x, y) {
        ...
        if (!failed && aClickPiece != aSelectedPiece) {
            if (aSelectedPiece != null) {
                if (
                    this.mLightningStorms.length == 0 &&
                    !this.QueueSwap(aSelectedPiece, aRow, aCol, false, true, false, false)
                ) {
                    aSelectedPiece.mSelected = false;
                    aSelectedPiece.mSelectorAlpha.SetConstant(0.0);
        ...
        if (!this.mTimeExpired && this.CanPlay()) {
            if (selectPiece && this.GetSelectedPiece() == null) {
                ...
                if (this.mCursorSelectPos.x == -1) {
                    ...
                    aPiece_2 = this.GetPieceAtScreenXY(
                        this.GetBoardX() + this.GetColX(this.mCursorSelectPos.x) + ((Game.Board.GEM_WIDTH / 2) | 0),
                        this.GetBoardY() + this.GetRowY(this.mCursorSelectPos.y) + ((Game.Board.GEM_HEIGHT / 2) | 0)
                    );
                }
                if (aPiece_2 != null) {
                    if (
            ...
            if (aDir.x != 0 || aDir.y != 0 || aSwapPiece != null) {
                ...
                if (aPiece_3 != null) {
                    ...
                    if (
                        ...
                        !this.QueueSwap(
                            aPiece_3,
                            aPiece_3.mRow + aDir.y,
                            aPiece_3.mCol + aDir.x,
                            false,
                            true,
                            false,
                            true
                ...
                if (this.mCursorSelectPos.x == -1) {
                    if (!selectPiece) {
                        this.mCursorSelectPos = new GameFramework.geom.TIntPoint(
                            (3 + Math.max(0, aDir.x)) | 0,
                            (3 + Math.max(0, aDir.y)) | 0
                        );
                    }
                } else if (moveCursor) {
                    this.mCursorSelectPos.x =
                        Math.max(0, Math.min(this.mColCount - 1, this.mCursorSelectPos.x + aDir.x)) | 0;
                    this.mCursorSelectPos.y =
                        Math.max(0, Math.min(this.mRowCount - 1, this.mCursorSelectPos.y + aDir.y)) | 0;
                }
            }
        }
    },
    KeyChar: function Game_Board$KeyChar(theChar) {
        ...
        if (Game.BejApp.mBejApp.mDebugKeysEnabled) {
            ...
            if (theChar == 116) {
                ...
                Game.BejApp.mBejApp.mAutoPlay =
                    ((Game.BejApp.mBejApp.mAutoPlay | 0) + 1) % (Game.DM.EAutoplay._COUNT | 0);
                this.mMessager.AddMessage(
                    String.format("Autoplay: {0}", Game.DM.gAutoplayDesc[Game.BejApp.mBejApp.mAutoPlay | 0])
                );
                ...
                if (aCursorPiece == null) {
                    aCursorPiece = this.CreateNewPiece(
                        this.GetRowAt(this.mLastMouseY | 0),
                        this.GetColAt((this.mLastMouseX | 0) - this.GetBoardX())
                    );
                }
        ...
        if (
            theChar == 32 &&
            this.mCursorSelectPos.x == -1 &&
            (this.WantsHideOnPause() || this.mUserPaused) &&
            !this.IsTutorialBusy()
        ) {
...
Game.Board.staticInit = function Game_Board$staticInit() {
    ...
    Game.Board.BACKGROUND_NAMES = Array.Create(
        20,
        "",
        "canyon_wall_castle.pam",
        "crystal_mountain_peak.pam",
        "dark_cave_thing.pam",
        "desert_pyramids_sunset.pam",
        "fairy_cave_village.pam",
        "floating_rock_city.pam",
        "flying_sail_boat.pam",
        "horse_forest_tree.pam",
        "jungle_ruins_path.pam",
        "lantern_plants_world.pam",
        "Lion_tower_cascade.pam",
        "pointy_ice_path.pam",
        "rock_city_lake.pam",
        "bridge_shroom_castles.pam",
        "snowy_cliffs_castle.pam",
        "treehouse_waterfall.pam",
        "tube_forest_night.pam",
        "water_bubble_city.pam",
        "water_fall_cliff.pam",
        "pointy_ice_path_purple.pam"
    );
    Game.Board.DESIRED_ORDER_LIST = Array.Create(
        19,
        19,
        10,
        7,

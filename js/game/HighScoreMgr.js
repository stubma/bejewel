...
Game.HighScoreMgr.prototype = {
    ...
    GenerateDefaults: function Game_HighScoreMgr$GenerateDefaults(
        theTable,
        theScoreStart,
        theScoreInterval,
        theScoreIntervalHi
    ...
    GenerateDefaults$3: function Game_HighScoreMgr$GenerateDefaults$3(
        theTable,
        theScoreStart,
        theScoreInterval,
        theScoreIntervalHi,
    ...
    Load: function Game_HighScoreMgr$Load() {
        var aHighScoreString = GameFramework.BaseApp.mApp.GetLocalData(
            GameFramework.BaseApp.mApp.mProdName,
            "HighScores"
        );
    ...
    Save: function Game_HighScoreMgr$Save() {
                    ...
                    for (var $enum5 = 0; $enum5 < $srcArray5.length; $enum5++) {
                        ...
                        aSaveTable.push(
                            Array.Create(
                                3,
                                null,
                                new GameFramework.misc.KeyVal("Name", aHighScoreEntry.mName),
                                new GameFramework.misc.KeyVal("Score", aHighScoreEntry.mScore),
                                new GameFramework.misc.KeyVal("Time", aHighScoreEntry.mTime)
                            )
                        );
                    }
                }
        ...
        GameFramework.BaseApp.mApp.SetLocalData(
            GameFramework.BaseApp.mApp.mProdName,
            "HighScores",
            GameFramework.BaseApp.mApp.EncodeJSON(aSaveData)
        );
        return true;
    },
};

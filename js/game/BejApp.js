...
Game.BejApp.prototype = {
    ...
    AddButtonSounds: function Game_BejApp$AddButtonSounds(theWidget) {
        theWidget.AddEventListener(
            GameFramework.widgets.WidgetEvent.CLICKED,
            ss.Delegate.create(this, this.PlayButtonClick)
        );
        theWidget.AddEventListener(
            GameFramework.widgets.WidgetEvent.MOUSE_DOWN,
            ss.Delegate.create(this, this.PlayButtonDown)
        );
    },
    ...
    Init: function Game_BejApp$Init() {
        ...
        this.SubmitStandardMetrics("startup", [
            new GameFramework.misc.KeyVal("DefaultArtRes", aDefaultArtRes),
            new GameFramework.misc.KeyVal("WebGL", this.get_Is3D()),
            new GameFramework.misc.KeyVal("ArtRes", this.mArtRes),
            new GameFramework.misc.KeyVal("PlatformInfo", this.mUserAgent),
        ]);
    ...
    StartLoad: function Game_BejApp$StartLoad() {
        ...
        aResourceStreamer.AddEventListener(
            ...
            ss.Delegate.create(this, this.ResourceXMLLoaded)
        );
        aResourceStreamer.AddEventListener(
            GameFramework.events.IOErrorEvent.IO_ERROR,
            ss.Delegate.create(this, this.LoadFailed)
        );
    },
    ...
    SubmitStandardMetricsDict: function Game_BejApp$SubmitStandardMetricsDict(
        theMetricsType,
        theMetricsData,
        force,
        theAlternateURL
    ...
    SubmitStandardMetrics: function Game_BejApp$SubmitStandardMetrics(
        theMetricsType,
        theMetricsData,
        force,
        theAlternateURL
        ...
        var aStats = [
            new GameFramework.misc.KeyVal("PlayerId", this.mUserId),
            new GameFramework.misc.KeyVal("ProductName", "Bejeweled"),
            new GameFramework.misc.KeyVal("PlatformName", "HTML5"),
            new GameFramework.misc.KeyVal("ClientVersion", Game.Version.Get()),
            new GameFramework.misc.KeyVal("SessionId", this.mSessionId),
        ];
        if (theMetricsData != null) {
            {
    ...
    StreamInitResources: function Game_BejApp$StreamInitResources() {
        ...
        this.mInitResourceStreamer.AddEventListener(
            GameFramework.events.Event.COMPLETE,
            ss.Delegate.create(this, this.InitLoadingComplete)
        );
        this.mInitResourceStreamer.AddEventListener(
            GameFramework.events.IOErrorEvent.IO_ERROR,
            ss.Delegate.create(this, this.LoadFailed)
    ...
    StreamResourceGroup: function Game_BejApp$StreamResourceGroup(theName) {
        ...
        this.mGroupsLoading++;
        aStreamer.AddEventListener(
            GameFramework.events.Event.COMPLETE,
            ss.Delegate.create(this, this.LoadingThreadLoadingComplete)
        );
        aStreamer.AddEventListener(
            GameFramework.events.IOErrorEvent.IO_ERROR,
            ss.Delegate.create(this, this.LoadFailed)
    ...
    InitLoadingComplete: function Game_BejApp$InitLoadingComplete(e) {
        ...
        aStreamer.AddEventListener(
            GameFramework.events.Event.COMPLETE,
            ss.Delegate.create(this, this.HyperspaceAnimLoaded)
        );
        aStreamer.AddEventListener(
            GameFramework.events.IOErrorEvent.IO_ERROR,
            ss.Delegate.create(this, this.LoadFailed)
    ...
    LoadingThreadLoadingComplete: function Game_BejApp$LoadingThreadLoadingComplete(e) {
        ...
        if (this.mGroupsLoading == 0 && !this.mLoadingThreadComplete) {
            ...
            this.SubmitStandardMetrics("load_complete", [
                new GameFramework.misc.KeyVal("LoadSeconds", (GameFramework.Utils.GetRunningMilliseconds() / 1000) | 0),
            ]);
            ...
            Game.Resources["FONT_DIALOG_BUTTONS"].PushLayerColor(
                "MAIN",
                GameFramework.gfx.Color.RGBAToInt(255, 255, 255, 230)
            );
            Game.Resources["FONT_DIALOG_BUTTONS"].PushLayerColor(
                "OUTLINE",
                GameFramework.gfx.Color.RGBAToInt(255, 255, 255, 255)
            );
            Game.Resources["FONT_DIALOG_BUTTONS"].PushLayerColor(
                "GLOW",
                GameFramework.gfx.Color.RGBAToInt(255, 255, 255, 128)
            );
            Game.Resources["FONT_DIALOG_HEADER"].PushLayerColor(
                "MAIN",
                GameFramework.gfx.Color.RGBAToInt(255, 255, 255, 230)
            );
            Game.Resources["FONT_DIALOG_HEADER"].PushLayerColor(
            ...
            Game.Resources["IMAGE_LIGHTNING_TIMER_LIGHTNING"].mPixelSnapping =
                GameFramework.resources.PixelSnapping.Never;
            Game.Resources["IMAGE_LIGHTNING_TIMER_GOLD_LIGHTNING"].mPixelSnapping =
                GameFramework.resources.PixelSnapping.Never;
            Game.Resources["IMAGE_LIGHTNING_TIMER_RED_LIGHTNING"].mPixelSnapping =
                GameFramework.resources.PixelSnapping.Never;
            ...
            this.mGems3D.push(
                this.mResourceManager.GetMeshResourceById(this.mResourceManager.PathToId("3d/gemRed.p3d"))
            );
            this.mGems3D.push(
                this.mResourceManager.GetMeshResourceById(this.mResourceManager.PathToId("3d/gemWhite.p3d"))
            );
            this.mGems3D.push(
                this.mResourceManager.GetMeshResourceById(this.mResourceManager.PathToId("3d/gemGreen.p3d"))
            );
            this.mGems3D.push(
                this.mResourceManager.GetMeshResourceById(this.mResourceManager.PathToId("3d/gemYellow.p3d"))
            );
            this.mGems3D.push(
                this.mResourceManager.GetMeshResourceById(this.mResourceManager.PathToId("3d/gemPurple.p3d"))
            );
            this.mGems3D.push(
                this.mResourceManager.GetMeshResourceById(this.mResourceManager.PathToId("3d/gemOrange.p3d"))
            );
            this.mGems3D.push(
                this.mResourceManager.GetMeshResourceById(this.mResourceManager.PathToId("3d/gemBlue.p3d"))
            );
            this.mWarpTube3D = this.mResourceManager.GetMeshResourceById(
                this.mResourceManager.PathToId("3d/warptube.p3d")
            );
            this.mWarpTube3D.AddEventListener(
                GameFramework.resources.MeshEvent.PREDRAW_SET,
                ss.Delegate.create(Game.HyperspaceUltra, Game.HyperspaceUltra.HypertubePredrawSet)
            );
            this.mWarpTube3D.AddEventListener(
                GameFramework.resources.MeshEvent.POSTDRAW_SET,
                ss.Delegate.create(Game.HyperspaceUltra, Game.HyperspaceUltra.HypertubePostdrawSet)
            );
            this.mWarpTubeCap3D = this.mResourceManager.GetMeshResourceById(
                this.mResourceManager.PathToId("3d/warptube_cap.p3d")
            );
        }
    },

    DoModalDialog: function Game_BejApp$DoModalDialog(
        theDialogHeader,
        theDialogLines,
        theDialogFooter,
        theButtonMode,
        ...
        var aDialog = new Game.Bej3Dialog(
    ...
    DoSimpleDialog: function Game_BejApp$DoSimpleDialog(
        theDialogHeader,
        theDialogLines,
        theDialogFooter,
        theButtonMode
        ...
        aDialog.mYesButton.AddEventListener(
            GameFramework.widgets.WidgetEvent.CLICKED,
            ss.Delegate.create(this, this.ButtonCloseDialog)
        );
    },
    ...
    LoadHyperspaceAnimConv: function Game_BejApp$LoadHyperspaceAnimConv(
        theDataBuffer,
        theHyperSpaceAnim,
        theOutBuffer
    ) {
        ...
        for (var row = 0; row < Game.Board.NUM_ROWS; ++row) {
            for (var col = 0; col < Game.Board.NUM_COLS; ++col) {
                theHyperSpaceAnim.mGemHitFrame[theHyperSpaceAnim.mGemHitFrame.mIdxMult0 * row + col] =
                    theHyperSpaceAnim.mFrameCount;
            }
        }
        if (formatVer >= 0x3) {
            ...
            for (var hiddenObjTableIdx = 0; hiddenObjTableIdx < numHiddenObjects; ++hiddenObjTableIdx) {
                ...
                theHyperSpaceAnim.mGemHitFrame[theHyperSpaceAnim.mGemHitFrame.mIdxMult0 * gemRow + gemCol] =
                    shouldHideAtFrameNum;
            }
        }
        ...
        for (var frame = 0; frame < frameCount; ++frame) {
            ...
            for (var row_2 = 0; row_2 < Game.Board.NUM_ROWS; ++row_2) {
                for (var col_2 = 0; col_2 < Game.Board.NUM_COLS; ++col_2) {
                    trackId_2 = theDataBuffer.ReadInt();
                    trackKind = theDataBuffer.ReadInt();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ] = new Game.HyperAnimKey();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mPos.x = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mPos.y = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mPos.z = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mRot.x = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mRot.y = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mRot.z = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mScale.x = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mScale.y = theDataBuffer.ReadFloat();
                    theHyperSpaceAnim.mGems[
                        theHyperSpaceAnim.mGems.mIdxMult0 * row_2 + theHyperSpaceAnim.mGems.mIdxMult1 * col_2 + frame
                    ].mScale.z = theDataBuffer.ReadFloat();
                    if (frame > 0) {
                        var aDelta = Math.abs(
                            aTrackingPos[aTrackingPos.mIdxMult0 * row_2 + col_2].x -
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                        frame
                                ].mPos.x
                        );
                        aXDeltaScale = Math.max(aDelta, aXDeltaScale);
                        aDelta = Math.abs(
                            aTrackingPos[aTrackingPos.mIdxMult0 * row_2 + col_2].y -
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                        frame
                        ...
                        aDelta = Math.abs(
                            aTrackingPos[aTrackingPos.mIdxMult0 * row_2 + col_2].z -
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                        frame
                        ...
                        aDelta = Math.abs(
                            aTrackingRot[aTrackingRot.mIdxMult0 * row_2 + col_2].x -
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                        frame
                        ...
                        aDelta = Math.abs(
                            aTrackingRot[aTrackingRot.mIdxMult0 * row_2 + col_2].y -
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                        frame
                        ...
                        aDelta = Math.abs(
                            aTrackingRot[aTrackingRot.mIdxMult0 * row_2 + col_2].z -
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                        frame
            ...
            for (var row_3 = 0; row_3 < Game.Board.NUM_ROWS; ++row_3) {
                for (var col_3 = 0; col_3 < Game.Board.NUM_COLS; ++col_3) {
                    if (frame == 0) {
                        aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3] = new GameFramework.geom.Vector3(
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                    frame
                            ].mPos.x,
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                        ...
                        aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3] = new GameFramework.geom.Vector3(
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                    frame
                        ...
                        var aDelta_2 =
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                    frame
                            ].mRot.x - aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].x;
                        if (Math.abs(aDelta_2) <= aXRotDeltaScale) {
                            xrotbyte = Game.BejApp.FloatToByte(aDelta_2, aXRotDeltaScale);
                            if (xrotbyte != 0) {
                                aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].x += Game.BejApp.ByteToFloat(
                                    xrotbyte,
                                    aXRotDeltaScale
                                );
                                aFlags |= 1;
                            ...
                            aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].x =
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                        frame
                        ...
                        aDelta_2 =
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                    frame
                            ].mRot.y - aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].y;
                        if (Math.abs(aDelta_2) <= aYRotDeltaScale) {
                            yrotbyte = Game.BejApp.FloatToByte(aDelta_2, aYRotDeltaScale);
                            if (yrotbyte != 0) {
                                aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].y += Game.BejApp.ByteToFloat(
                                    yrotbyte,
                                    aYRotDeltaScale
                                );
                                aFlags |= 2;
                            ...
                            aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].y =
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                        frame
                        ...
                        aDelta_2 =
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                    frame
                            ].mRot.z - aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].z;
                        if (Math.abs(aDelta_2) <= aZRotDeltaScale) {
                            zrotbyte = Game.BejApp.FloatToByte(aDelta_2, aZRotDeltaScale);
                            if (zrotbyte != 0) {
                                aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].z += Game.BejApp.ByteToFloat(
                                    zrotbyte,
                                    aZRotDeltaScale
                                );
                                aFlags |= 4;
                            ...
                            aTrackingRot[aTrackingRot.mIdxMult0 * row_3 + col_3].z =
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                        theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                        frame
                        ...
                        var aPrevTrackingPos = new GameFramework.geom.Vector3(
                            aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].x,
                            aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].y,
                            aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].z
                        );
                        var aString =
                            "" +
                            frame +
                            " Cur:" +
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * 0 + theHyperSpaceAnim.mGems.mIdxMult1 * 0 + frame
                            ].mPos.x;
                                ...
                                aDelta_2 =
                                    theHyperSpaceAnim.mGems[
                                        theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                            theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                            frame
                                    ].mPos.x - aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].x;
                                if (Math.abs(aDelta_2) <= aXDeltaScale) {
                                    xbyte = Game.BejApp.FloatToByte(aDelta_2, aXDeltaScale);
                                    if (xbyte != 0) {
                                        aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].x +=
                                            Game.BejApp.ByteToFloat(xbyte, aXDeltaScale);
                                        aString +=
                                            " Guessing:" + aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].x;
                                        aFlags |= 8;
                                    }
                                } else {
                                    aString +=
                                ...
                                aDelta_2 =
                                    theHyperSpaceAnim.mGems[
                                        theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                            theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                            frame
                                    ].mPos.y - aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].y;
                                if (Math.abs(aDelta_2) <= aYDeltaScale) {
                                    ybyte = Game.BejApp.FloatToByte(aDelta_2, aYDeltaScale);
                                    if (ybyte != 0) {
                                        aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].y +=
                                            Game.BejApp.ByteToFloat(ybyte, aYDeltaScale);
                                        aFlags |= 32;
                                    }
                                } else {
                                    aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].y =
                                ...
                                aDelta_2 =
                                    theHyperSpaceAnim.mGems[
                                        theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                            theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                            frame
                                    ].mPos.z - aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].z;
                                if (Math.abs(aDelta_2) <= aZDeltaScale) {
                                    zbyte = Game.BejApp.FloatToByte(aDelta_2, aZDeltaScale);
                                    if (xbyte != 0) {
                                        aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].z +=
                                            Game.BejApp.ByteToFloat(zbyte, aZDeltaScale);
                                        aFlags |= 128;
                                    }
                                } else {
                                    aTrackingPos[aTrackingPos.mIdxMult0 * row_3 + col_3].z =
                        ...
                        if ((aFlags & 1) != 0) {
                            ...
                            theOutBuffer.WriteShort(
                                Game.BejApp.RotToShort(
                                    theHyperSpaceAnim.mGems[
                                        theHyperSpaceAnim.mGems.mIdxMult0 * row_3 +
                                            theHyperSpaceAnim.mGems.mIdxMult1 * col_3 +
                                            frame
            ...
            for (var light = 0; light < lightCount; ++light) {
                trackId_2 = theDataBuffer.ReadInt();
                trackKind = theDataBuffer.ReadInt();
                theHyperSpaceAnim.mLights[theHyperSpaceAnim.mLights.mIdxMult0 * light + frame] =
                    new Game.HyperAnimKey();
                theHyperSpaceAnim.mLights[theHyperSpaceAnim.mLights.mIdxMult0 * light + frame].mPos.x =
                    theDataBuffer.ReadFloat();
                theHyperSpaceAnim.mLights[theHyperSpaceAnim.mLights.mIdxMult0 * light + frame].mPos.y =
                    theDataBuffer.ReadFloat();
                theHyperSpaceAnim.mLights[theHyperSpaceAnim.mLights.mIdxMult0 * light + frame].mPos.z =
                    theDataBuffer.ReadFloat();
                theOutBuffer.WriteFloat(
                    theHyperSpaceAnim.mLights[theHyperSpaceAnim.mLights.mIdxMult0 * light + frame].mPos.x
                );
                            ...
                            theHyperSpaceAnim.mGems[
                                ...
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        ...
                                        frame -
                                        1
                                ].mRot.x + Game.BejApp.ByteToFloat(theDataBuffer.ReadByte(), aXRotDeltaScale);
                        } else if ((aFlags & 1024) != 0) {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                    frame
                            ].mRot.x = Game.BejApp.ShortToRot(theDataBuffer.ReadShort());
                        } else {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                            ...
                            theHyperSpaceAnim.mGems[
                                ...
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        ...
                                        frame -
                                        1
                                ].mRot.y + Game.BejApp.ByteToFloat(theDataBuffer.ReadByte(), aYRotDeltaScale);
                        } else if ((aFlags & 2048) != 0) {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                    frame
                            ].mRot.y = Game.BejApp.ShortToRot(theDataBuffer.ReadShort());
                        } else {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                            ...
                            theHyperSpaceAnim.mGems[
                                ...
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        ...
                                        frame -
                                        1
                                ].mRot.z + Game.BejApp.ByteToFloat(theDataBuffer.ReadByte(), aZRotDeltaScale);
                        } else if ((aFlags & 4096) != 0) {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                                    frame
                            ].mRot.z = Game.BejApp.ShortToRot(theDataBuffer.ReadShort());
                        } else {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                            ...
                            theHyperSpaceAnim.mGems[
                                ...
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        ...
                                        frame -
                                        1
                                ].mPos.x + Game.BejApp.ByteToFloat(theDataBuffer.ReadByte(), aXDeltaScale);
                        } else if ((aFlags & 16) != 0) {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                            ...
                            theHyperSpaceAnim.mGems[
                                ...
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        ...
                                        frame -
                                        1
                                ].mPos.y + Game.BejApp.ByteToFloat(theDataBuffer.ReadByte(), aYDeltaScale);
                        } else if ((aFlags & 64) != 0) {
                            theHyperSpaceAnim.mGems[
                                theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                    theHyperSpaceAnim.mGems.mIdxMult1 * col_2 +
                            ...
                            theHyperSpaceAnim.mGems[
                                ...
                                theHyperSpaceAnim.mGems[
                                    theHyperSpaceAnim.mGems.mIdxMult0 * row_2 +
                                        ...
                                        frame -
                                        1
                                ].mPos.z + Game.BejApp.ByteToFloat(theDataBuffer.ReadByte(), aZDeltaScale);

...
Game.Metrics.prototype = {
    ...
    SetSamplingProbRoll: function Game_Metrics$SetSamplingProbRoll(theSamplingProbRoll) {
        ...
        GameFramework.BaseApp.mApp.SetLocalData(
            "Global",
            "SamplingProbRoll",
            String.format("{0}", this.mSamplingProbRoll)
        );
    },
    SubmitReport: function Game_Metrics$SubmitReport(theMetricsType, theMetricsData, force, theAlternateURL) {
        ...
        var aStats = [
            new GameFramework.misc.KeyVal("MetricsType", theMetricsType),
            new GameFramework.misc.KeyVal("MetricsVersion", "v1.0"),
            new GameFramework.misc.KeyVal("SamplingProb", aSamplingProb),
        ];
    ...
    SetThrottlingURL: function Game_Metrics$SetThrottlingURL(theThrottlingURL) {
        ...
        aConnectedRequest.AddEventListener(
            ...
            ss.Delegate.create(this, this.GotThrottlingData)
        );

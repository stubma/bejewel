                ...
                for (var i = 0; i < fxArr.length; ) {
                    ...
                    switch (anEffect.mType) {
                        ...
                        case Game.Effect.EFxType.EMBER_FADEINOUT: {
                            ...
                            if (
                                anEffect.mType == Game.Effect.EFxType.EMBER_FADEINOUT ||
                        ...
                        case Game.Effect.EFxType.COUNTDOWN_SHARD: {
                            ...
                            aSmoke.mScale *=
                                anEffect.mScale * (0.0 + Math.abs(GameFramework.Utils.GetRandFloat()) * 0.45);
...

        {
            ...
            for (var $enum2 = 0; $enum2 < $srcArray2.length; $enum2++) {
                ...
                for (var i = 0; i < fxArr.length; ++i) {
                    ...
                    if (
                        anEffect.mPieceIdRel != -1 &&
                        anEffect.mType != Game.Effect.EFxType.PI &&
                        anEffect.mType != Game.Effect.EFxType.POPANIM &&
                        anEffect.mType != Game.Effect.EFxType.TIME_BONUS &&
                        anEffect.mType != Game.Effect.EFxType.TIME_BONUS_TOP &&
                        anEffect.mType != Game.Effect.EFxType.CUSTOMCLASS
                    ) {
                        if (this.mBoard != null) {
                            aPieceRel = this.mBoard.GetPieceById(anEffect.mPieceIdRel);
                        }
                    ...
                    switch (anEffect.mType) {
                        case Game.Effect.EFxType.NONE: {
                            var _t3 = g.PushColor(
                                GameFramework.gfx.Color.UInt_AToInt(anEffect.mColor, (255.0 * anAlpha) | 0)
                            );
                            try {
                        ...
                        case Game.Effect.EFxType.SPARKLE_SHARD: {
                            ...
                            anEffect.mColor = GameFramework.gfx.Color.UInt_AToInt(
                                anEffect.mColor,
                                (255.0 * anAlpha) | 0
                            );
                            ...
                            g.DrawImageCel(
                                anImage,
                                anEffect.mX - ((aWidth / 2) | 0),
                                anEffect.mY - ((aHeight / 2) | 0),
                                anEffect.mFrame
                            );
                            g.PopColor();
                        ...
                        case Game.Effect.EFxType.WALL_ROCK: {
                            g.DrawImageCel(
                                anEffect.mImage,
                                anEffect.mX - ((anEffect.mImage.mPhysCelWidth / 2) | 0),
                                anEffect.mY - ((anEffect.mImage.mPhysCelHeight / 2) | 0),
                                anEffect.mFrame
                            );

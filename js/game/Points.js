Game.Points = function Game_Points(
    theApp,
    theFont,
    theString,
    theX,
...
Game.Points.prototype = {
    ...
    Draw: function Game_Points$Draw(g) {
        ...
        if (
            this.mSubStringShowTick >= 0 &&
            this.mSubStringShowTick <= this.mUpdateCnt &&
            this.mSubString != "" &&
            this.mSubFont != null
        ) {
    ...
    SetupForDraw: function Game_Points$SetupForDraw(g) {
        ...
        if (this.mFont == Game.Resources["FONT_FLOATERS"]) {
            for (var i = 0; i < aLayerNames.length; i++) {
                ...
                aLayerColor = GameFramework.gfx.Color.UInt_FAToInt(
                    aLayerColor,
                    this.mAlpha * ((aLayerColor >>> 24) / 255.0)
                );

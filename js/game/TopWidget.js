...
Game.TopWidget.prototype = {
    ...
    InitMessager: function Game_TopWidget$InitMessager() {
        ...
        GameFramework.BaseApp.mApp.AddEventListener(
            GameFramework.widgets.WidgetEvent.KEY_CHAR,
            ss.Delegate.create(this, this.HandleKeyChar)
        );
    },
            ...
            for (var i = 0; i < 2; ++i) {
                ...
                if (Game.BejApp.mBejApp.mAutoPlay != Game.DM.EAutoplay.None) {
                    g.DrawString(
                        String.format(
                            "Autoplay: {0} -- {1}",
                            Game.DM.gAutoplayDesc[Game.BejApp.mBejApp.mAutoPlay | 0],
                            Game.Util.TicksToString(Game.Board.mTotalTicks)
                        ),
                        8,
                        22
                    );

Game.RankUpDialog = function Game_RankUpDialog(theBoard) {
    ...
    Game.RankUpDialog.initializeBase(this, [
        null,
        Game.Resources["IMAGE_DIALOG_BUTTON"],
        Game.DM.EDialog.RANK_AWARD,
        true,
        "RANK UP",
        "",
        "",
...
Game.RankUpDialog.prototype = {
    ...
    Draw: function Game_RankUpDialog$Draw(g) {
        ...
        var _t1 = g.PushColor(
            GameFramework.gfx.Color.RGBAToInt(255, 255, 255, (255.0 * this.mBoard.GetBoardAlpha()) | 0)
        );
        try {
            ...
            if ((this.mRankBarWidget.GetRankPointsRemaining() | 0) > 0) {
                ...
                Game.Resources["FONT_GAMEOVER_DIALOG"].PushLayerColor(
                    "GLOW",
                    GameFramework.gfx.Color.RGBAToInt(192, 96, 48, 80)
                );
                Game.Resources["FONT_GAMEOVER_DIALOG"].PushLayerColor(
                    "OUTLINE",
                    GameFramework.gfx.Color.RGBToInt(64, 32, 16)
                );
                g.DrawStringCentered(
                    GameFramework.Utils.CommaSeperate(this.mRankBarWidget.GetRankPointsRemaining() | 0) + ",000 Points",
                    aX,
                    aY
                );
            ...
            try {
                var _t5 = g.PushColor(
                    GameFramework.gfx.Color.RGBAToInt(255, 255, 255, (255.0 * aGlowAlpha.GetOutVal()) | 0)
                );
                try {
                    g.DrawStringCentered(this.mRankBarWidget.GetRankName(aRank), aX, aY);
                } finally {

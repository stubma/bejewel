Game.SpeedCollectEffect = function Game_SpeedCollectEffect(
    theSpeedBoard,
    theSrc,
    theTgt,
    theTimeCollected,
...
Game.SpeedCollectEffect.prototype = {
    ...
    Update: function Game_SpeedCollectEffect$Update() {
        ...
        if (this.mCentering) {
            this.mX =
                this.mStartPoint.x +
                this.mSplineInterp.GetOutVal() * (this.mFXManager.mBoard.GetBoardCenterX() - this.mStartPoint.x);
            this.mY =
                this.mStartPoint.y +
                this.mSplineInterp.GetOutVal() * (this.mFXManager.mBoard.GetBoardCenterY() - this.mStartPoint.y);

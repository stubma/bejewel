...
Game.DialogMgr.prototype = {
    ...
    Update: function Game_DialogMgr$Update() {
        ...
        if (
            this.mDialogDarkenBackPct.get_v() != 0.0 &&
            this.mDialogDarkenBackPct.GetOutFinalVal() != 0.0 &&
            (this.mDialogList.length == 0 ||
                (Type.tryCast(this.mDialogList[this.mDialogList.length - 1], Game.Bej3Dialog) &&
                    (!this.mDialogList[this.mDialogList.length - 1].mWantsDarken ||
                        (this.mDialogList.length == 1 && this.mDialogList[this.mDialogList.length - 1].mIsKilling) ||
                        (this.mDialogList.length == 2 &&
                            this.mDialogList[this.mDialogList.length - 1].mIsKilling &&
                            !this.mDialogList[0].mWantsDarken))))
        ) {
